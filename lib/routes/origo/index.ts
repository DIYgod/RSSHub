...
const rootUrl = 'https://www.origo.hu';
const feedUrl = 'https://api.origo.hu/publicapi/hu/rss/origo/gazdasag/articles';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/origo',
    radar: [{ source: ['origo.hu/', 'origo.hu/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'origo.hu/',
    handler,
