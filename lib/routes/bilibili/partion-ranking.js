...
module.exports = async (ctx) => {
    ...
    for (let i = 0; i < hotlist.length; i++) {
        ...
        item = {
            title: `${item.title}`,
            description:
                `${item.description}<img src="https:${item.pic}"><br/>Tags:${item.tag}` +
                `<br><iframe src="https://player.bilibili.com/player.html?aid=${item.id}" width="640" height="360" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>`,
