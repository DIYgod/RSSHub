    ...
    ctx.state.data = {
        ...
        item: data.map((item) => {
            ...
            return {
                title: getTitle(data),
<<<<<<< HEAD
                description: `${data_content || getDes(data)}${origin && getOriginName(origin) ? `<br><br>//转发自: @${getOriginName(origin)}: ${getOriginTitle(origin.item || origin)}${getDes(origin.item || origin)}` : `${getOriginDes(origin)}`
=======
...
>>>>>>> 184fb498b5922b40e0f321d5a3d867b5fc1f3a0c
