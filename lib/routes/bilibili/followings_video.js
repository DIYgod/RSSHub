    ...
    const out = await Promise.all(
        cards.map(async (card) => {
            ...
            const item = {
                ...
                description:
                    `${card_data.desc}<br><img src="${card_data.pic}">` +
                    `<br><iframe src="https://player.bilibili.com/player.html?aid=${card_data.aid}" width="640" height="360" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>`,
