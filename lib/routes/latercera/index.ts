...
const rootUrl = 'https://www.latercera.com';
const feedUrl = 'https://www.latercera.com/rss';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/latercera',
    radar: [{ source: ['latercera.com/', 'latercera.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'latercera.com/',
    handler,
