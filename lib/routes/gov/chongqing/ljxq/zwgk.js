...
module.exports = async (ctx) => {
    ...
    if (!cfg) {
        throw Error('Bad category. See <a href="http://localhost:8080/government.html#zhong-qing-shi-ren-min-zheng-fu-liang-jiang-xin-qu-xin-xi-gong-kai-wang-zheng-wu-gong-kai">docs</a>');
    }
