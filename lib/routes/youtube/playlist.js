...
module.exports = async (ctx) => {
    ...
    ctx.state.data = {
        ...
        item: data.map((item, index) => {
            ...
            return {
                title: snippet.title,
                description: `${embed ? '<iframe id="ytplayer" type="text/html" width="640" height="360" src="https://www.youtube-nocookie.com/embed/' + videoId + '" frameborder="0" allowfullscreen></iframe>' : '<img src="' + img.url + '">'}
