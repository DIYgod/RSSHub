...
module.exports = async (ctx) => {
    ...
    const embed = ctx.params.embed === undefined || ctx.params.embed === 'true';
    const maxResults = ctx.params.maxResults;
    ...
    const data = (await utils.getPlaylistItems(playlistId, 'snippet,contentDetails', maxResults)).data.items;
