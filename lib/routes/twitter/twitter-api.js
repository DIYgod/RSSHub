...
const getUserTweets = async (screenName, params = {}) => getLegacyTwit(await timelineMedia(screenName, params));
const getUserTweetsAndReplies = async (screenName, params = {}) => getLegacyTwit(await timelineTweetsAndReplies(screenName, params));
const getUserMedia = async (screenName, params = {}) => getLegacyTwit(await timelineTweets(screenName, params));
