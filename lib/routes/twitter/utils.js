...
const ProcessFeed = (ctx, { data = [] }, params = {}) => {
    const newParams = {
        ...
        showQuotedAuthorAvatarInDesc: fallback(params.showQuotedAuthorAvatarInDesc, queryToToBoolean(ctx.query.showQuotedAuthorAvatarInDesc), false),
        showAuthorAvatarInDesc: fallback(params.showAuthorAvatarInDesc, queryToToBoolean(ctx.query.showAuthorAvatarInDesc), false),
        showEmojiForRetweetAndReply: fallback(params.showEmojiForRetweetAndReply, queryToToBoolean(ctx.query.showEmojiForRetweetAndReply), false),
        ...
        showQuotedInTitle: fallback(params.showQuotedInTitle, queryToToBoolean(ctx.query.showQuotedInTitle), false),
        ...
        heightOfQuotedAuthorAvatar: fallback(params.heightOfQuotedAuthorAvatar, queryToToInteger(ctx.query.heightOfQuotedAuthorAvatar), 24),
    };
