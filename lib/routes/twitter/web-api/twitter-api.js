...
const getUserData = (cache, screenName) => cache.tryGet(`twitter-userdata-${screenName}`, async () => await userByScreenName(screenName));
...
const getUserTweets = async (cache, screenName, params = {}) => await getUserTweetsByID(await getUserID(cache, screenName), params);
const getUserTweetsAndReplies = async (cache, screenName, params = {}) => await getUserTweetsAndRepliesByID(await getUserID(cache, screenName), params);
const getUserMedia = async (cache, screenName, params = {}) => await getUserMediaByID(await getUserID(cache, screenName), params);
const getUserLikes = async (cache, screenName, params = {}) => await getUserLikesByID(await getUserID(cache, screenName), params);
