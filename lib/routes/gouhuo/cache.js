...
module.exports = {
    ...
    getTitle: async (self, ctx) => {
        return (await self._getProfile(ctx)).title;
    },
    getDescription: async (self, ctx) => {
        return (await self._getProfile(ctx)).description;
    },
}