...
const rootUrl = 'https://www.prensa.com';
const feedUrl = 'https://www.prensa.com/arc/outboundfeeds/rss/?outputType=xml';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/prensa',
    radar: [{ source: ['prensa.com/', 'prensa.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'prensa.com/',
    handler,
