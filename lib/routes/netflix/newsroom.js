...
module.exports = async (ctx) => {
    ...
    const currentUrl = `${rootUrl}/api/data/articles?language=${languages.hasOwnProperty(region) ? languages[region] : region.replaceAll('_', '-')}${category === 'all' ? '' : `&category=${categories[category].id}`}`;
