...
export default async (ctx) => {
    ...
    if (ctx.originalUrl.startsWith(`/coolapk/tuwen-xinxian`) || type === 'latest') {
        ...
        // 精选
        full_url = utils.base_url + '/v6/page/dataList?url=%23%2Ffeed%2FdigestList%3Ftype%3D12%26is_html_article%3D1%26recommend%3D3%252C4&title=%E5%9B%BE%E6%96%87&page=1';
        feedTitle = `酷安图文 - 编辑精选`;
    }
