...
const jiaowuValue = ['https://jiaowu.nwsuaf.edu.cn/tzggB/', 'ul.list li', 'a', '.article2', `西北农林科技大学教务通知公告`];
const newsValue = ['https://news.nwafu.edu.cn/yxxw/', 'ul.NWAFU-list01  li', 'li a', '.pageArticle', `西北农林科技大学新闻网聚焦院处`];
const nicValue = ['https://nic.nwsuaf.edu.cn/gzdt2/tzgg1/', 'dl#sort ul.list  li', 'li a', '.article', `西北农林科技大学信息化管理处通知公告`];
...
const cmeeValue = ['https://cmee.nwafu.edu.cn/xwzx/xytz/', '#list-content > div', 'a', '#content', '西北农林科技大学机械与电子工程学院通知公告'];
