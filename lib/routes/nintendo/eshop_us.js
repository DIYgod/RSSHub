...
module.exports = async (ctx) => {
    const response = await got({
        method: 'post',
        url: `https://u3b6gr4ua3-dsn.algolia.net/1/indexes/store_game_en_us_release_des/query?x-algolia-application-id=U3B6GR4UA3&x-algolia-api-key=a29c6927638bfd8cee23993e51e721c9`,
        json: {
    ...
    ctx.state.data = {
        ...
        item: data.map((item) => ({
            title: item.title,
            description: art(path.join(__dirname, 'templates/eshop_en.art'), item),
