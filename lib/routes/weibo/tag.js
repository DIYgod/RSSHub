...
module.exports = async (ctx) => {
    ...
    const response = await got({
        method: 'get',
        url: `https://weibo.com/a/hot/${encodeURIComponent(tagName)}.html`,
        headers: {
            Referer: `https://weibo.com/a/hot/${encodeURIComponent(tagName)}.html`,
            'MWeibo-Pwa': 1,
    ...
    ctx.state.data = {
        ...
        link: `http://s.weibo.com/weibo/${encodeURIComponent(tagName)}&b=1&nodup=1`,
