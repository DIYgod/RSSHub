...
export const route: Route = {
    ...
    maintainers: ['Chikit'],
    name: '中国地质科学院研究生院要闻简讯',
    parameters: {
        no_parameters: '该路由无需额外参数',
    },
    radar: [
        {
            source: ['edu.cags.ac.cn/#/dky/list/barId=ywjx/cmsNavType=1'],
            target: '/ywjx',
        },
    ],
    handler: async () => {
        const API_URL = 'https://edu.cags.ac.cn/api/cms/cmsNews/pageByCmsNavBarId/ywjx/1/10/0';
        ...
        const items = data.map((item) => {
            ...
            const link = `https://edu.cags.ac.cn/#/dky/view/id=${id}/barId=ywjx`;
        ...
        return {
            title: '中国地质科学院研究生院要闻简讯',
            link: 'https://edu.cags.ac.cn/#/dky/list/barId=ywjx/cmsNavType=1',
            item: items,
        };
    },
};
