...
const rootUrl = 'https://stluciastar.com';
const feedUrl = 'https://stluciastar.com/rss';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/stluciastar',
    radar: [{ source: ['stluciastar.com/', 'stluciastar.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'stluciastar.com/',
    handler,
...
async function handler(ctx) {
    ...
    return {
        title: feed.title || 'St. Lucia Star',
