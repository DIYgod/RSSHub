...
const rootUrl = 'https://www.southsudannewsagency.com';
const rootHost = 'southsudannewsagency.com';
const hrefPattern = /\/\d{4}\/\d{2}\/\d{2}\/[^?#]+/;
...
export const route: Route = {
    ...
    example: '/southsudannewsagency',
    radar: [{ source: ['southsudannewsagency.com/', 'southsudannewsagency.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'southsudannewsagency.com/',
    handler,
};
