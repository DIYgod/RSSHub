...
const host = 'https://ddys.art';

module.exports = async (ctx) => {
    const url = ctx.params.tag ? `${host}/tag/${encodeURIComponent(ctx.params.tag)}/` : ctx.params.category ? `${host}/category/${ctx.params.category}/` : host;
