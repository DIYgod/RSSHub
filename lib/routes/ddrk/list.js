...
module.exports = async (ctx) => {
    const url = ctx.params.tag ? `https://ddys.tv/tag/${encodeURIComponent(ctx.params.tag)}/` : ctx.params.category ? `https://ddys.tv/category/${ctx.params.category}/` : 'https://ddys.tv/';
