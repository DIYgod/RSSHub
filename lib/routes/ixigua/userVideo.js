...
module.exports = async (ctx) => {
    ...
    const videoApiUrl = `${homeUrl}/api/videov2/author/new_video_list?_signature=_02B4Z6wo00f01mG-4EAAAIDC4bwaA8BM5U5hmuTAAPp-19&to_user_id=${uid}&offset=0&limit=20&order=new`;
