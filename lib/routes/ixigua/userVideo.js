...
module.exports = async (ctx) => {
    ...
    ctx.state.data = {
        ...
        item: videoInfos.map((i) => ({
            title: i.title,
            description: `<iframe width="720" height="405" frameborder="0" allowfullscreen src="https://www.ixigua.com/iframe/${i.gid}?autoplay=0&startTime=0"></iframe><p>${i.abstract}</p><img src="${i.middle_image.url}" />`,
            link: `${homeUrl}/${i.gid}`,
