...
const rootUrl = 'https://somalilandpress.com';
const rootHost = 'somalilandpress.com';
const hrefPattern = /\/[a-z0-9-]{15,}/;
...
export const route: Route = {
    ...
    example: '/somalilandpress',
    radar: [{ source: ['somalilandpress.com/', 'somalilandpress.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'somalilandpress.com/',
    handler,
};
