...
const rootUrl = 'https://www.namibian.com.na';
const feedUrl = 'https://www.namibian.com.na/rss';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/namibian',
    radar: [{ source: ['namibian.com.na/', 'namibian.com.na/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'namibian.com.na/',
    handler,
