...
const rootUrl = 'https://www.azatutyun.am';
const feedUrl = 'https://www.azatutyun.am/api/';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/azatutyun',
    radar: [{ source: ['azatutyun.am/', 'azatutyun.am/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'azatutyun.am/',
    handler,
...
async function handler(ctx) {
    ...
    return {
        title: feed.title || 'Radio Free Armenia',
