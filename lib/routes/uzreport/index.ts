...
const rootUrl = 'https://www.uzreport.news';
const rootHost = 'uzreport.news';
const hrefPattern = /\/(?:society|economy|politics|tech)\/[a-z0-9-]+/;
...
export const route: Route = {
    ...
    example: '/uzreport',
    radar: [{ source: ['uzreport.news/', 'uzreport.news/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'uzreport.news/',
    handler,
