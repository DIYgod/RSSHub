...
const rootUrl = 'https://www.qatar-tribune.com';
const rootHost = 'qatar-tribune.com';
...
export const route: Route = {
    ...
    example: '/qatartribune',
    radar: [{ source: ['qatar-tribune.com/', 'qatar-tribune.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'qatar-tribune.com/',
    handler,
};
