...
const rootUrl = 'https://www.trtworld.com';
const feedUrl = 'https://www.trtworld.com/feed/rss.xml';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/trtworld',
    radar: [{ source: ['trtworld.com/', 'trtworld.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'trtworld.com/',
    handler,
