...
const rootUrl = 'https://www.lefaso.net';
const feedUrl = 'https://www.lefaso.net/spip.php?page=backend';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/lefaso',
    radar: [{ source: ['lefaso.net/', 'lefaso.net/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'lefaso.net/',
    handler,
