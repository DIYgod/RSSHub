            ...
            list
                .map((item) => {
                    ...
                    return {
                        ...
                        description: 'Name: '.bold() + videoJapanseName + '<br>' + 'Brand: '.bold() + videoBrand + '<br>' + 'Tags: '.bold() + videoTags + '<br>' +  'Description: '.bold() + videoDescription + '<br>' + '<img referrerpolicy="no-referrer" src="' + videoCover + '">' + '<br>' + '<img referrerpolicy="no-referrer" src="' + videoImage + '">',
                        link: videoUrl,
                    };
                }),
        ),
