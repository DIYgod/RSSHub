...
const rootUrl = 'https://timesofindia.indiatimes.com';
const rootHost = 'timesofindia.indiatimes.com';
...
export const route: Route = {
    ...
    example: '/timesofindia',
    radar: [{ source: ['timesofindia.indiatimes.com/', 'timesofindia.indiatimes.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
