...
module.exports = async (ctx) => {
    ...
    const apiUrl = `${rootUrl}/api/v1/search/${type}?keyword=${keyword}&brand_type=0&category=${caty}&order=${order}${rating === 'all' ? '' : rating === 'general' ? '&rating=general' : '&adult=1'}&per_page=30`;
