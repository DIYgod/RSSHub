...
const rootUrl = 'https://turkmenportal.com';
const rootHost = 'turkmenportal.com';
const hrefPattern = /\/[a-z0-9-]+\/\d{4,}/;
...
export const route: Route = {
    ...
    example: '/turkmenportal',
    radar: [{ source: ['turkmenportal.com/', 'turkmenportal.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'turkmenportal.com/',
    handler,
};
