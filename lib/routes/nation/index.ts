...
const rootUrl = 'https://www.nation.co.ke';
const feedUrl = 'https://nation.africa/kenya/rss.xml';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/nation',
    radar: [{ source: ['nation.co.ke/', 'nation.co.ke/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'nation.co.ke/',
    handler,
