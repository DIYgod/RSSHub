...
const renderItemDescription = (data: ItemDetail['data']) =>
    renderToString(
        <>
            ...
            <h2> 商品の説明 </h2>
            <div>{raw(data.description.replaceAll('\n', '<br/>'))}</div>
            <h2> 商品の情報 </h2>
            <table>
                <tr>
                    <td>カテゴリー</td>
                    <td>
                        {data.item_category.root_category_name} &gt; {data.item_category.parent_category_name} &gt; {data.item_category.name}
                    </td>
                </tr>
                <tr>
                    <td>商品の状態</td>
...
const renderShopItemDescription = (detail: ShopItemDetail) =>
    renderToString(
        <>
            ...
            <h2> 商品の説明 </h2>
            <div>{raw(detail.productDetail.description.replaceAll('\n', '<br/>'))}</div>
            <h2> 商品の情報 </h2>
            <table>
                <tr>
                    <td>カテゴリー</td>
                ...
                <tr>
                    <td>商品の状態</td>
                    <td> {detail.productDetail.condition.displayName} </td>
                </tr>
                <tr>
                    <td>配送料の負担</td>
                    <td> {detail.productDetail.shippingPayer.displayName} </td>
                </tr>
                <tr>
                    <td>配送の方法</td>
                    <td> {detail.productDetail.shippingMethod.displayName} </td>
                </tr>
                <tr>
                    <td>発送元の地域</td>
                    <td> {detail.productDetail.shippingFromArea.displayName} </td>
                </tr>
                <tr>
                    <td>発送までの日数</td>
                    <td> {detail.productDetail.shippingDuration.displayName} </td>
                </tr>
            </table>
            <h2> 出品者 </h2>
            <div style="display:flex">
