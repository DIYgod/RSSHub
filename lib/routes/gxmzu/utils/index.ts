...
// Fall back to the list-page data when a single article fails to load, so one bad page does not break the whole feed; content of off-site links (e.g. WeChat posts) is not fetched
