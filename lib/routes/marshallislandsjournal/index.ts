...
const rootUrl = 'https://www.marshallislandsjournal.com';
const apiUrl = `${rootUrl}/wp-json/wp/v2/posts`;

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/marshallislandsjournal',
    radar: [
        {
            source: ['marshallislandsjournal.com/', 'marshallislandsjournal.com/*'],
            target: '/',
        },
    ],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'marshallislandsjournal.com/',
    handler,
};
...
async function handler(ctx) {
    ...
    return {
        title: 'Marshall Islands Journal',
        link: rootUrl,
        language: 'en',
        item: items,
    };
