...
const url = 'https://news.qq.com/ch/world';
const api = 'https://i.news.qq.com/web_backend/v2/getTagInfo?tagId=aEKuxr1YhGQ%3D';

const headers = {
    'user-agent':
        'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Safari/537.36',
    accept: 'application/json, text/plain, */*',
    referer: 'https://news.qq.com/ch/world',
...
export const route: Route = {
    ...
    handler: async () => {
        ...
        if (!articleList.length) {
            throw new Error('QQ world getTagInfo returned empty articleList');
        }
