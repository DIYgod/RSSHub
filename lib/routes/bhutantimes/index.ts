...
const rootUrl = 'https://www.bhutantimes.com';
const feedUrl = 'https://www.bhutantimes.com/rss';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/bhutantimes',
    radar: [{ source: ['bhutantimes.com/', 'bhutantimes.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'bhutantimes.com/',
    handler,
