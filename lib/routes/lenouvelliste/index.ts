...
const rootUrl = 'https://lenouvelliste.com';
const feedUrl = 'https://lenouvelliste.com/rss.xml';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/lenouvelliste',
    radar: [{ source: ['lenouvelliste.com/', 'lenouvelliste.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'lenouvelliste.com/',
    handler,
};
...
async function handler(ctx) {
    ...
    return {
        title: feed.title || 'Le Nouvelliste',
