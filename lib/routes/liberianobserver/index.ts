...
const rootUrl = 'https://www.liberianobserver.com';
const rootHost = 'liberianobserver.com';
...
export const route: Route = {
    ...
    example: '/liberianobserver',
    radar: [{ source: ['liberianobserver.com/', 'liberianobserver.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'liberianobserver.com/',
    handler,
};
