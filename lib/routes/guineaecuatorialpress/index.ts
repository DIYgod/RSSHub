...
const rootUrl = 'https://www.guineaecuatorialpress.com';
const rootHost = 'guineaecuatorialpress.com';
const hrefPattern = /\/noticias\/[a-z0-9_]+/;
...
export const route: Route = {
    ...
    example: '/guineaecuatorialpress',
    radar: [{ source: ['guineaecuatorialpress.com/', 'guineaecuatorialpress.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'guineaecuatorialpress.com/',
    handler,
};
