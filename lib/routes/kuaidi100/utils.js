...
async function getCookie(ctx) {
    ...
    if (!wwwid || !csrf || !dasddocTitl || !dasddocReferrer || !dasddocHref) {
        ...
        ctx.cache.set(globacsrftoken_key, globacsrftoken, 5);
        ctx.cache.set(dasddocTitl_key, dasddocTitl, 5);
        ctx.cache.set(dasddocReferrer_key, dasddocReferrer, 5);
        ctx.cache.set(dasddocHref_key, dasddocHref, 5);
