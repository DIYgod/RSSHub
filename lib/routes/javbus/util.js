...
=======
        const filmCover = /<a class="bigImage" href="(.*?)"/.exec(detailPage)[1];
        const filmName = /<a class="bigImage" href="(.*?)" title="(.*?)"/.exec(detailPage)[2];
>>>>>>> 5bdbd2d762f093f02356ae20bf865c31ebbf70cc
...
<<<<<<< HEAD
        const detail = { actresses, filmTime, filmLast, filmEstabName, filmMakerbName, seriesName, directorName, code, screenData }; // filmCover, filmName,
=======
