...
const rootUrl = 'https://www.ekathimerini.com';
const feedUrl = 'https://feeds.feedburner.com/ekathimerini/sKip';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/ekathimerini',
    radar: [{ source: ['ekathimerini.com/', 'ekathimerini.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
