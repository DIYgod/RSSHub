    ...
    if (`${id[0]}` === '8') {
        ...
        items = playList.map(function (video) {
            ...
            const info = {
                ...
                link: video.playUrl,
                description: `
                        <iframe src="https://v.qq.com/txp/iframe/player.html?vid=${video_id}" width="640" height="430"></iframe>
                    `,
            };
            return info;
        });
        ...
        items = playList.map((video) => ({
            ...
            link: video.playUrl,
            description: `
                    <iframe  src="https://v.qq.com/txp/iframe/player.html?vid=${video.id}" width="640" height="430"></iframe>
                `,
        }));
    }
