...
const rootUrl = 'https://libyaobserver.ly';
const rootHost = 'libyaobserver.ly';
const hrefPattern = /\/(?:news|sports|economy)\/[a-z0-9-]+/;
...
export const route: Route = {
    ...
    example: '/libyaobserver',
    radar: [{ source: ['libyaobserver.ly/', 'libyaobserver.ly/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'libyaobserver.ly/',
    handler,
};
