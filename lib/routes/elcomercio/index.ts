...
const rootUrl = 'https://elcomercio.pe';
const feedUrl = 'https://elcomercio.pe/arcio/rss/';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/elcomercio',
    radar: [{ source: ['elcomercio.pe/', 'elcomercio.pe/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'elcomercio.pe/',
    handler,
