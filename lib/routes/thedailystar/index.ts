...
const rootUrl = 'https://www.thedailystar.net';
const feedUrl = 'https://www.thedailystar.net/rss.xml';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/thedailystar',
    radar: [{ source: ['thedailystar.net/', 'thedailystar.net/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
...
async function handler(ctx) {
    ...
    return {
        title: feed.title || 'The Daily Star',
