...
const subsiteDic = {
    ...
    ssdut: {
        listSelector: '.rj_zp_con2 li',
        titleMethod: titleMethod1,
        linkMethod: linkMethod1,
        pubDateMethod: pubDateMethod1,
        descriptionMethod: descriptionMethod1,
        typeMap: {
            yjs: { title: '大连理工大学软件学院-研究生通知', url: 'http://ssdut.dlut.edu.cn/yjspy/yjspy/yjstz.htm', basePath: 'http://ssdut.dlut.edu.cn/yjspy/yjspy/' },
        },
    },
    pg: {
        listSelector: '.index_news01.fl > ul > li',
        titleMethod: titleMethod1,
        linkMethod: linkMethod1,
        pubDateMethod: pubDateMethod1,
        descriptionMethod: descriptionMethod1,
        typeMap: {
            zytz: { title: '大连理工大学研究生院-重要通告', url: 'http://gs.dlut.edu.cn/index.htm', basePath: 'http://gs.dlut.edu.cn/' },
        },
    },
    eda: {
        listSelector: '.ny_list li',
        titleMethod: titleMethod1,
        linkMethod: linkMethod1,
        pubDateMethod: pubDateMethod1,
        descriptionMethod: descriptionMethod1,
        typeMap: {
            tzgg: { title: '大连理工大学开发区校区-通知公告', url: 'http://eda.dlut.edu.cn/tzgg/tzgg.htm', basePath: 'http://eda.dlut.edu.cn/tzgg/' },
        },
    },
};
