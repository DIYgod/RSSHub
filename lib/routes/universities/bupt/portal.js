...
module.exports = async (ctx) => {
    const response = await got({
        method: 'get',
        url: `https://wx.bupt.edu.cn/portal-article-page/article-list/notice?limit=10&offset=0`,
        cookieJar,
    });
    ...
    ctx.state.data = {
        title: '北京邮电大学信息门户',
        link: 'https://wx.bupt.edu.cn/portal-article-page/article-list/notice?limit=10&offset=0',
        item: out,
    };
};
