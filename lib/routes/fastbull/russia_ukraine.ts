...
const russiaUkraineTagIds = '108';

export const route: Route = {
    path: '/russia_ukraine',
    categories: ['finance'],
    view: ViewType.Articles,
    example: '/fastbull/russia_ukraine',
    parameters: {},
    features: {
        requireConfig: false,
    ...
    radar: [
        {
            ...
            target: '/fastbull/russia_ukraine',
        },
    ],
    name: '\u4fc4\u4e4c\u51b2\u7a81\u5feb\u8baf',
...
async function handler(ctx) {
    ...
    const body = await getFastBullBody(russiaUkraineTagIds, '0', limit);

    return {
        title: 'FastBull \u4fc4\u4e4c\u51b2\u7a81\u5feb\u8baf',
        link: currentUrl,
        description: 'FastBull \u5feb\u8baf - \u4fc4\u4e4c\u51b2\u7a81 - \u5168\u90e8',
