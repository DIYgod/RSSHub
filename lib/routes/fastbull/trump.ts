...
const trumpTagIds = '176';

export const route: Route = {
    path: '/trump',
    categories: ['finance'],
    view: ViewType.Articles,
    example: '/fastbull/trump',
    parameters: {},
    features: {
        requireConfig: false,
...
async function handler(ctx) {
    ...
    const body = await getFastBullBody(trumpTagIds, '0', limit);

    return {
        title: 'FastBull 特朗普动态快讯',
        link: currentUrl,
        description: 'FastBull 快讯 - 特朗普动态',
