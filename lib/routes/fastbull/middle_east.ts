...
const middleEastTagIds = '177';

export const route: Route = {
    path: '/middle_east',
    categories: ['finance'],
    view: ViewType.Articles,
    example: '/fastbull/middle_east',
    parameters: {},
    features: {
        requireConfig: false,
...
async function handler(ctx) {
    ...
    const body = await getFastBullBody(middleEastTagIds, '0', limit);

    return {
        title: 'FastBull \u4e2d\u4e1c\u7126\u70b9\u5feb\u8baf',
        link: currentUrl,
        description: 'FastBull \u5feb\u8baf - \u4e2d\u4e1c\u7126\u70b9 - \u5168\u90e8',
