...
const rootUrl = 'https://www.bangkokpost.com';
const feedUrl = 'https://www.bangkokpost.com/rss/src/topstories.xml';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/bangkokpost',
    radar: [{ source: ['bangkokpost.com/', 'bangkokpost.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'bangkokpost.com/',
    handler,
