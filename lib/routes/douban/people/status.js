...
function getContentByActivity(ctx, item, params = {}, picsPrefixes = []) {
    const newParams = {
        ...
        showAuthorInTitle: fallback(params.showAuthorInTitle, queryToToBoolean(ctx.query.showAuthorInTitle), true),
        ...
        showRetweetTextInTitle: fallback(params.showRetweetTextInTitle, queryToToBoolean(ctx.query.showRetweetTextInTitle), false),
        ...
        showComments: fallback(params.showComments, queryToToBoolean(ctx.query.showComments), false),
