...
export const route: Route = {
    ...
    parameters: { category: '分类，默认为 `2/11`，即行业资讯，可在对应分类页 URL 中找到' },
    description: `:::tip
  ...
  | [7/25](https://rsshub.app/cbpanet/dzp_news/7/25)                        | [7/26](https://rsshub.app/cbpanet/dzp_news/7/26)                              | [7/27](https://rsshub.app/cbpanet/dzp_news/7/27)                                  | [7/29](https://rsshub.app/cbpanet/dzp_news/7/29)                      | [7/41](https://rsshub.app/cbpanet/dzp_news/7/41)                    | [7/49](https://rsshub.app/cbpanet/dzp_news/7/49)                    |
    ...
    radar: [
        ...
        {
            title: '协会 - 协会介绍',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=1&smallid=1'],
            target: '/dzp_news/1/1',
        },
        {
            title: '协会 - 协会章程',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=1&smallid=2'],
            target: '/dzp_news/1/2',
        },
        {
            title: '协会 - 理事会',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=1&smallid=3'],
            target: '/dzp_news/1/3',
        },
        {
            title: '协会 - 内设机构',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=1&smallid=4'],
            target: '/dzp_news/1/4',
        },
        {
            title: '协会 - 协会通知',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=1&smallid=5'],
            target: '/dzp_news/1/5',
        },
        {
            title: '协会 - 协会活动',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=1&smallid=6'],
            target: '/dzp_news/1/6',
        },
        {
            title: '协会 - 出版物',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=1&smallid=7'],
            target: '/dzp_news/1/7',
        },
        {
            title: '协会 - 会员权利与义务',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=1&smallid=30'],
            target: '/dzp_news/1/30',
        },
        {
            title: '行业资讯 - 国内资讯',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=2&smallid=8'],
            target: '/dzp_news/2/8',
        },
        {
            title: '行业资讯 - 海外资讯',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=2&smallid=9'],
            target: '/dzp_news/2/9',
        },
        {
            title: '行业资讯 - 企业新闻',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=2&smallid=10'],
            target: '/dzp_news/2/10',
        },
        {
            title: '行业资讯 - 行业资讯',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=2&smallid=11'],
            target: '/dzp_news/2/11',
        },
        {
            title: '行业资讯 - 热点聚焦',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=2&smallid=43'],
            target: '/dzp_news/2/43',
        },
        {
            title: '行业资讯 - 今日推荐',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=2&smallid=44'],
            target: '/dzp_news/2/44',
        },
        {
            title: '原料信息 - 价格行情',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=3&smallid=12'],
            target: '/dzp_news/3/12',
        },
        {
            title: '原料信息 - 分析预测',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=3&smallid=13'],
            target: '/dzp_news/3/13',
        },
        {
            title: '原料信息 - 原料信息',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=3&smallid=40'],
            target: '/dzp_news/3/40',
        },
        {
            title: '原料信息 - 热点聚焦',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=3&smallid=45'],
            target: '/dzp_news/3/45',
        },
        {
            title: '法规标准 - 法规资讯',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=4&smallid=15'],
            target: '/dzp_news/4/15',
        },
        {
            title: '法规标准 - 法律法规',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=4&smallid=16'],
            target: '/dzp_news/4/16',
        },
        {
            title: '法规标准 - 国内标准',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=4&smallid=14'],
            target: '/dzp_news/4/14',
        },
        {
            title: '法规标准 - 国外标准',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=4&smallid=17'],
            target: '/dzp_news/4/17',
        },
        {
            title: '法规标准 - 法规聚焦',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=4&smallid=46'],
            target: '/dzp_news/4/46',
        },
        {
            title: '法规标准 - 今日推荐',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=4&smallid=47'],
            target: '/dzp_news/4/47',
        },
        {
            title: '技术专区 - 产品介绍',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=5&smallid=18'],
            target: '/dzp_news/5/18',
        },
        {
            title: '技术专区 - 科技成果',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=5&smallid=19'],
            target: '/dzp_news/5/19',
        },
        {
            title: '技术专区 - 学术论文',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=5&smallid=20'],
            target: '/dzp_news/5/20',
        },
        {
            title: '技术专区 - 资料下载',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=5&smallid=21'],
            target: '/dzp_news/5/21',
        },
        {
            title: '技术专区 - 专家',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=5&smallid=50'],
            target: '/dzp_news/5/50',
        },
        {
            title: '技术专区 - 民间智库',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=5&smallid=57'],
            target: '/dzp_news/5/57',
        },
        {
            title: '豆制品消费指南 - 膳食指南',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=6&smallid=22'],
            target: '/dzp_news/6/22',
        },
        {
            title: '豆制品消费指南 - 营养成分',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=6&smallid=23'],
            target: '/dzp_news/6/23',
        },
        {
            title: '豆制品消费指南 - 豆食菜谱',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=6&smallid=24'],
            target: '/dzp_news/6/24',
        },
        {
            title: '豆制品消费指南 - 问与答',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=6&smallid=31'],
            target: '/dzp_news/6/31',
        },
        {
            title: '豆制品消费指南 - 今日推荐',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=6&smallid=48'],
            target: '/dzp_news/6/48',
        },
        {
            title: '豆制品消费指南 - 消费热点',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=6&smallid=53'],
            target: '/dzp_news/6/53',
        },
        {
            title: '营养与健康 - 大豆营养概况',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=7&smallid=25'],
            target: '/dzp_news/7/25',
        },
        {
            title: '营养与健康 - 大豆食品和人类健康',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=7&smallid=26'],
            target: '/dzp_news/7/26',
        },
        {
            title: '营养与健康 - 世界豆类日，爱豆大行动',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=7&smallid=27'],
            target: '/dzp_news/7/27',
        },
        {
            title: '营养与健康 - 谣言粉碎机',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=7&smallid=29'],
            target: '/dzp_news/7/29',
        },
        {
            title: '营养与健康 - 最新资讯',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=7&smallid=41'],
            target: '/dzp_news/7/41',
        },
        {
            title: '营养与健康 - 专家视点',
            source: ['www.cbpanet.com/dzp_news.aspx?bigid=7&smallid=49'],
