...
module.exports = async (ctx) => {
    ...
    const userProfilePublicProfile = data.userProfilePublicProfile;
    ...
    const description = `全站排名 ${siteRanking} <br>解决的题目 ${acTotal} / ${questionTotal} <br>通过的提交 ${acSubmissions} / ${totalSubmissions} <br>提交通过率 ${ProgressNumber * 100} % <br><img referrerpolicy="no-referrer" src="${userAvatar}">`;
    ...
    const dic_lang = {"A_0":"C++", "A_1":"Java", "A_2":"Python", "A_3":"MySQL", "A_4":"C", "A_5":"C#", "A_6":"JavaScript", "A_7":"Ruby", "A_8":"Bash", "A_9":"Swift", "A_10":"Go", "A_11":"Python3", "A_12":"Scala", "A_13":"Kotlin", "A_14":"MS SQL Server", "A_15":"Oracle", "A_16":"HTML", "A_17":"Python ML", "A_18":"Rust", "A_19":"PHP"};
    const dic_status = {"A_10":"accepted", "A_11":"wrong-answer", "A_12":"memory-limit-exceeded", "A_13":"output-limit-exceeded", "A_14":"time-limit-exceeded", "A_15":"runtime-error", "A_16":"internal-error", "A_20":"compile-error", "A_30":"timeout"};
