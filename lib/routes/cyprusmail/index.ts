...
const rootUrl = 'https://cyprus-mail.com';
const feedUrl = 'https://cyprus-mail.com/feed';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/cyprusmail',
    radar: [{ source: ['cyprus-mail.com/', 'cyprus-mail.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'cyprus-mail.com/',
    handler,
