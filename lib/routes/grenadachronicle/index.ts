...
const rootUrl = 'https://grenadachronicle.com';
const apiUrl = `${rootUrl}/wp-json/wp/v2/posts`;

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/grenadachronicle',
    radar: [
        {
            source: ['grenadachronicle.com/', 'grenadachronicle.com/*'],
            target: '/',
        },
    ],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'grenadachronicle.com/',
    handler,
};
