...
const rootUrl = 'https://www.adiac-congo.com';
const feedUrl = 'https://www.adiac-congo.com/rss.xml';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/brazzavilleadiac',
    radar: [{ source: ['brazzaville-adiac.com/', 'brazzaville-adiac.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'brazzaville-adiac.com/',
    handler,
};
