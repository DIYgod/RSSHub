...
export async function extractMasonryArticleLinks() {
    const feedUrl = `${rootUrl}/feed/topic/56439/page/1`;
...
export async function fetchArticleContent(item: any): Promise<DataItem> {
    try {
