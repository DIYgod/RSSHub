...
const rootUrl = 'https://samoaobserver.ws';
const rootHost = 'samoaobserver.ws';
const hrefPattern = /\/category\/[^/]+\/\d+/;
...
export const route: Route = {
    ...
    example: '/samoaobserver',
    radar: [{ source: ['samoaobserver.ws/', 'samoaobserver.ws/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'samoaobserver.ws/',
    handler,
};
