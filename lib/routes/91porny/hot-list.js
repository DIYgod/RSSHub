...
async function generateIframe(url) {
    ...
    // const src = iframeBaseUrl + videoId;
    // <iframe src='https://91porny.com/video/embed/10717207ac4001a06ed2' frameborder='0' width='640' height='340' scrolling='no' allowfullscreen></iframe>
...
async function generateItems(elems, loadedData) {
    ...
    for (const i of elems) {
        ...
        const description = await generateIframe(url);
        const single = {
            title: title,
