...
const utils = {
    ...
    parseDatetime: (t, o, r, tz, l) => {
        ...
        switch (l) {
            case 'ja':
                // customFormat = DateTime.fromFormat(t, formatJaDate).isValid ? formatJaDate : DateTime.fromFormat(t, formatJaDateTime).isValid ? formatJaDateTime : undefined;
                ...
                break;
            case 'en':
                // customFormat = DateTime.fromFormat(t, formatEnDate).isValid ? formatEnDate : DateTime.fromFormat(t, formatEnDateTime).isValid ? formatEnDateTime : undefined;
        ...
        return [
            // DateTime.fromFormat(t, customFormat, {
            //     zone: tz,
            // }).valueOf(),
