...
const rootUrl = 'https://maldivesindependent.com';
const feedUrl = 'https://maldivesindependent.com/api/rss/news';

export const route: Route = {
    path: '/',
    categories: ['traditional-media'],
    example: '/maldivesindependent',
    radar: [{ source: ['maldivesindependent.com/', 'maldivesindependent.com/*'], target: '/' }],
    name: 'News',
    maintainers: ['lisyer'],
    url: 'maldivesindependent.com/',
    handler,
};
...
async function handler(ctx) {
    ...
    return {
        title: feed.title || 'Maldives Independent',
