...
module.exports = async (ctx, next) => {
    ...
    let image_hotlink_template = null;
    const multimedia_hotlink_template = config.feature.allow_user_hotlink_template ? ctx.query.image_hotlink_template : null;
