...
- Additional info (logs errors etc)
    ...
    ${err.message}`;
            ...
            message += `<br><br>如果您认为 RSSHub 导致了该错误，<a href="https://github.com/DIYgod/RSSHub/issues/new?template=bug_report_zh.md&body=${encodeURI(templateZh)}" target="_blank">请在 GitHub 报告</a>。`;

            message += `<br><br>If you believe this is an error caused by RSSHub, please <a href="https://github.com/DIYgod/RSSHub/issues/new?template=bug_report_en.md&body=${encodeURI(
                templateEn
