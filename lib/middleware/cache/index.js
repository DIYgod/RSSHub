...
module.exports = function (app) {
    ...
    return async (ctx, next) => {
        ...
        const controlKey = 'path-requested:' + ctx.request.path;
        ...
        console.log(`value set for ${controlKey}`)
        await next();
        ...
        await globalCache.set(controlKey, false, config.cache.requestTimeout);
        console.log(`value unset for ${controlKey}`)
    };
};
