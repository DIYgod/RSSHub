module.exports = {
    ...
    'v2ex.com': {
        ...
        '.': [
            {
                title: '帖子',
                docs: 'https://docs.rsshub.app/bbs.html#v2ex-tie-zi',
                source: '/t/:postId',
                target: (params) => `/v2ex/posts/${params.postId}`,
            },
            {
                title: '标签',
                docs: 'https://docs.rsshub.app/bbs.html#v2ex',
                source: '/',
                target: (params, url) => {
                    const tabName = new URL(url).searchParams.get('tab');
                    return tabName && `/v2ex/tab/${tabName}`;
                },
            },
        ],
    },
