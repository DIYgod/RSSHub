...
module.exports = async (ctx) => {
    ...
    const currentUrl = `${rootUrl}/toc/${id}/current?sortBy=DATE`;
            ...
            return $('.issue-item')
                ...
                .map((item) => {
                    ...
                    return {
                        ...
                        guid: doi,
                        title: a.text(),
                        link: `${rootUrl}${a.attr('link')}`,
                        pubDate: parseDate(item.find('.pub-date-value').text(), 'MMM DD, YYYY'),
                        author: item
                        ...
                        description: art(path.join(__dirname, 'templates/description.art'), {
                            image: item.find('.issue-item_img img').attr('src'),
