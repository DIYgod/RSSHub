...
module.exports = async (ctx) => {
    ...
    const avatarAvatarUrl = $('.header-avatar-img').attr('src');
    const items = $('.author-work .author-item')
        ...
        .map((item) => {
            ...
            return {
                ...
                author: art(path.join(__dirname, 'templates/author.art'), {
                    avatar: avatarAvatarUrl,
                    link: currentUrl,
                    name: authorName,
                }),
                ...
                pubDate: date(messageItem.find('.author-item-update span').text().trim(), 8),
