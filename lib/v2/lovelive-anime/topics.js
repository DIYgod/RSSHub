...
module.exports = async (ctx) => {
    ...
    const url = Object.prototype.hasOwnProperty.call(ctx.params, 'category') && ctx.params.category !== 'detail' ? `${rootUrl}/${topicsUrlPart}?cat=${ctx.params.category}` : `${rootUrl}/${topicsUrlPart}`;
