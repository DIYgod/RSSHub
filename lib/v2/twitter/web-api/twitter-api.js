...
const timelineKeywords = (keywords) =>
    twitterGot(
        `https://twitter.com/i/api${graphQLMap.SearchTimeline}`,
        {
            variables: JSON.stringify({
                rawQuery: keywords,
                count: 20,
...
const getSearch = (keywords, params = {}) => timelineKeywords(keywords, params).then((data) => gatherLegacyFromData(data.data.search_by_raw_query.search_timeline.timeline.instructions[0].entries || []));
