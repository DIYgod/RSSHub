...
const bakeFilterSearchParams = (filterPairs, pairKey, isApi = false) => {
    ...
    const bakeFilters = (filterPairs, filterSearchParams) => {
        const keys = Object.keys(filterPairs).filter((key) => filterPairs[key]?.length > 0 && (isApi ? Object.prototype.hasOwnProperty.call(filterApiKeys, key) : Object.prototype.hasOwnProperty.call(filterKeys, key)));
        ...
        filterSearchParams.append(getFilterKeyForSearchParams(key, isApi), pairs.map((pair) => (Object.prototype.hasOwnProperty.call(pair, pairKey) ? pair[pairKey] : pair)).join(','));
...
const getFilterKeyForSearchParams = (key, isApi = false) => {
    ...
    return Object.prototype.hasOwnProperty.call(keys, key) ? keys[key] ?? key : undefined;
};
...
const parseFilterStr = (filterStr) => {
    ...
    const parseStr = (filterStr, filters = {}, filterKey) => {
        ...
        const isKey = Object.prototype.hasOwnProperty.call(filterApiKeys, word);
