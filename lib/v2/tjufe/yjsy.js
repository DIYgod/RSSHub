...
const host = 'https://yjsy.tjufe.edu.cn';
module.exports = async (ctx) => {
    ...
    const typeName = $('.winstyle125290 a').last().text() || '研究生院';
    const list = $('.winstyle132388 > tbody tr a');
    ...
    ctx.state.data = {
        title: `天津财经大学研究生院 - ${typeName}`,
        link: pageUrl,
        description: `天津财经大学研究生院 - ${typeName}`,
        item: items,
    };
};
