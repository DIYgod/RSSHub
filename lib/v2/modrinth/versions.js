...
module.exports = async (
    ...
    try {
         ...
         */
        const versions = await got(`https://api.modrinth.com/v2/project/${id}/version?loaders=${JSON.stringify(loaders)}&game_versions=${JSON.stringify(game_versions)}&featured=${featured}`).json();
        /**
