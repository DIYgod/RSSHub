module.exports = function (router) {
    ...
    router.get('/jinan/healthcommission/medical_exam_notice', require('./jinan/healthcommission/medical-exam-notice'));
    ...
    router.get('/pbc/tradeAnnouncement', require('./pbc/trade-announcement'));
    ...
    router.get('/ccp/news/', require('./ccp/news'));
};
