module.exports = {
    ...
    'dianbai.gov.cn': {
        ...
        www: [
            {
                title: '政务公开 > 政策解读',
                docs: 'https://docs.rsshub.app/government.html#mao-ming-shi-dian-bai-qu-ren-min-zheng-fu',
                source: ['/*'],
                target: (params, url) => `/gov/dianbai/${new URL(url).href.match(/dianbai\.gov\.cn\/(.*)/)[1]}`,
            },
        ],
    },
    'gaozhou.gov.cn': {
        ...
        www: [
            {
                title: '政务公开 > 政策解读',
                docs: 'https://docs.rsshub.app/government.html#gao-zhou-shi-ren-min-zheng-fu',
                source: ['/*'],
                target: (params, url) => `/gov/gaozhou/${new URL(url).href.match(/gaozhou\.gov\.cn\/(.*)/)[1]}`,
            },
        ],
    },
    'hebei.gov.cn': {
    ...
    'huazhou.gov.cn': {
        ...
        www: [
            {
                title: '政务公开 > 政策解读',
                docs: 'https://docs.rsshub.app/government.html#hua-zhou-shi-ren-min-zheng-fu',
                source: ['/*'],
                target: (params, url) => `/gov/huazhou/${new URL(url).href.match(/huazhou\.gov\.cn\/(.*)/)[1]}`,
            },
        ],
    },
    'huizhou.gov.cn': {
    ...
    'maoming.gov.cn': {
        ...
        www: [
            {
                title: '政务公开 > 政策解读 > 部门解读',
                docs: 'https://docs.rsshub.app/government.html#mao-ming-shi-ren-min-zheng-fu-men-hu-wang-zhan',
                source: ['/*'],
                target: (params, url) => `/gov/maoming/${new URL(url).href.match(/maoming\.gov\.cn\/(.*)/)[1]}`,
            },
        ],
    },
    'maonan.gov.cn': {
        ...
        '.': [
            {
                title: '政务公开',
                docs: 'https://docs.rsshub.app/government.html#mao-ming-shi-mao-nan-qu-ren-min-zheng-fu',
                source: ['/zwgk/*'],
    ...
    'mgs.gov.cn': {
        ...
        www: [
            {
                title: '政务公开 > 政策解读',
                docs: 'https://docs.rsshub.app/government.html#guang-dong-mao-ming-bin-hai-xin-qu-zheng-wu-wang',
                source: ['/*'],
                target: (params, url) => `/gov/mgs/${new URL(url).href.match(/mgs\.gov\.cn\/(.*)/)[1]}`,
            },
        ],
    },
    'miit.gov.cn': {
    ...
    'mmht.gov.cn': {
        _name: '茂名高新技术产业开发区政务网',
        www: [
            {
                title: '政务公开 > 政策解读',
                docs: 'https://docs.rsshub.app/government.html#mao-ming-gao-xin-ji-shu-chan-ye-kai-fa-qu-zheng-wu-wang',
                source: ['/*'],
                target: (params, url) => `/gov/mmht/${new URL(url).href.match(/mmht\.gov\.cn\/(.*)/)[1]}`,
            },
        ],
    },
    'moe.gov.cn': {
    ...
    'sdb.gov.cn': {
        ...
        www: [
            {
                title: '政务公开 > 政策解读',
                docs: 'https://docs.rsshub.app/government.html#guang-dong-sheng-mao-ming-shui-dong-wan-xin-cheng-jian-she-guan-li-wei-yuan-hui',
                source: ['/*'],
                target: (params, url) => `/gov/sdb/${new URL(url).href.match(/sdb\.gov\.cn\/(.*)/)[1]}`,
            },
        ],
    },
    'sh.gov.cn': {
    ...
    'xinyi.gov.cn': {
        ...
        www: [
            {
                title: '政务公开 > 政策解读',
                docs: 'https://docs.rsshub.app/government.html#xin-yi-shi-ren-min-zheng-fu',
                source: ['/*'],
                target: (params, url) => `/gov/xinyi/${new URL(url).href.match(/xinyi\.gov\.cn\/(.*)/)[1]}`,
            },
        ],
    },
    'www.gov.cn': {
