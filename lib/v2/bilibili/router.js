module.exports = (router) => {
    ...
    router.get('/collection/:uid/:sid/:disableEmbed?', require('./collection'));
    ...
    router.get('/user/channel/collections/:uid/:sid/:disableEmbed?', require('./userChannelCollections'));
    router.get('/user/channel/series/:uid/:sid/:disableEmbed?', require('./userChannelSeries'));
