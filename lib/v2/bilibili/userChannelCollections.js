...
module.exports = async (ctx) => {
    ...
    const host = `https://api.bilibili.com/x/polymer/space/seasons_archives_list?mid=${uid}&season_id=${sid}&sort_reverse=false&page_num=1&page_size=10`;
    ...
    const channelName = data.meta.name;

    ctx.state.data = {
        title: `${userName} 的 bilibili 频道的合集 ${channelName}`,
        link,
