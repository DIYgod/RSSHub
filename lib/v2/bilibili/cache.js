...
module.exports = {
    ...
    getStaticVerifyString: (ctx) => {
        ...
        return ctx.cache.tryGet(key, async () => {
            ...
            const response = await got(`https://s1.hdslb.com/bfs/static/jinkela/space/9.space.ecceb61b045ad88627ce742a4fdd10a68c0ab747.js`, {
                headers: {
                    Referer: `https://space.bilibili.com/1/`,
                },
            });
            const array = JSON.parse(response.body.match(/\[(?:\d+,){63}\d+\]/));
            const r = "162d9a373be342dbb91eff71ed0a894cf53968b083f2431bb0efed8606707956";
            const o = [];
            array.forEach(((t) => {
