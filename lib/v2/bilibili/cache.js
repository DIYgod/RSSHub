    ...
    getArticleDataFromCvid: async (ctx, cvid, uid) => {
        ...
        if (!description) {
            try {
                ...
                if (newFormatData && newFormatData.readInfo && newFormatData.readInfo.opus && newFormatData.readInfo.opus.content && newFormatData.readInfo.opus.content.paragraphs) {
                    description = '';
