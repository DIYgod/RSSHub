...
module.exports = async (ctx) => {
    ...
    const {meta: {total}} = channelInfo;
    const pageSize = total || 100;
    ...
    const host = `https://api.bilibili.com/x/series/archives?mid=${uid}&series_id=${sid}&only_normal=true&sort=desc&pn=1&ps=${pageSize}`;
