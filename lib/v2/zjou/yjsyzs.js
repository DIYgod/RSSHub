...
const host = 'http://yjsyzs.zjou.edu.cn';
module.exports = async (ctx) => {
    ...
    const typeName = $('.dqwz .fl').text() || '研究生招生网';
    const list = $('.artical ul li');
    ...
    ctx.state.data = {
        title: `浙江海洋大学研究生招生网 - ${typeName}`,
        link: pageUrl,
        description: `浙江海洋大学研究生招生网 - ${typeName}`,
        item: items,
    };
};
