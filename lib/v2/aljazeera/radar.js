module.exports = {
    'aljazeera.com': {
        ...
        '.': [
            {
                title: 'News',
                docs: 'https://docs.rsshub.app/new-media.html#aljazeera-ban-dao-dian-shi-tai-xin-wen',
                source: ['/:category', '/'],
                target: '/aljazeera/english/:category',
            },
            {
                title: 'Tag',
                docs: 'https://docs.rsshub.app/new-media.html#aljazeera-ban-dao-dian-shi-tai-biao-qian',
                source: ['/tag/:id', '/'],
                target: '/aljazeera/english/tag/:id',
            },
            {
                title: 'Official RSS',
                docs: 'https://docs.rsshub.app/new-media.html#aljazeera-ban-dao-dian-shi-tai-guan-fang-rss',
