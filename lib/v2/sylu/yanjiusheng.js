...
const host = 'https://yanjiusheng.sylu.edu.cn';
module.exports = async (ctx) => {
    ...
    ctx.state.data = {
        title: `沈阳理工大学研究生院 - ${typeName}`,
        link: pageUrl,
        description: `沈阳理工大学研究生院 - ${typeName}`,
        item: items,
    };
};
