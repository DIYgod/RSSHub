...
const processAudioInfo = (info) => {
    const quality = info ? audioQualities.find((quality) => Object.prototype.hasOwnProperty.call(info, `audio_${quality === '' ? '' : `${quality}_`}path`)) : undefined;
    ...
    const processed = {
        ...
        size: Object.prototype.hasOwnProperty.call(info, sizeKey) ? info[sizeKey] : undefined,
        src: info[linkKey],
...
const processVideoInfo = (info) => {
    const quality = info ? videoQualities.find((quality) => Object.prototype.hasOwnProperty.call(info, `${quality}_link`)) : undefined;
