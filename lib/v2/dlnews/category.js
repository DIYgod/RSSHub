...
module.exports = async (ctx) => {
    ...
    ctx.state.data = {
        title: Object.prototype.hasOwnProperty.call(topics, category) ? `${topics[category]} : DL News` : 'DL News',
        link: baseUrl,
        item: items,
        description: Object.prototype.hasOwnProperty.call(topics, category) ? `${topics[category]} : News on dlnews.com` : 'Latest News on dlnews.com',
