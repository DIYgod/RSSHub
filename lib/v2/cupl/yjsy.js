...
const host = 'http://yjsy.cupl.edu.cn';
...
module.exports = async (ctx) => {
    ...
    const typeName = $('.left_lanmu > ul > li > a').text() || '研究生院';
    const list = $('.list_con li');
    ...
    ctx.state.data = {
        title: `中国政法大学研究生院 - ${typeName}`,
        link: pageUrl,
        description: `中国政法大学研究生院 - ${typeName}`,
        item: items,
    };
};
