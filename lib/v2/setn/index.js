...
const getCurrentUrl = (category) => {
    const rootUrl = Object.prototype.hasOwnProperty.call(rootUrls, category) ? rootUrls[category] : defaultRootUrl;

    if (Object.prototype.hasOwnProperty.call(ids, category)) {
...
module.exports = async (ctx) => {
    ...
    let items = $('#NewsList, .newsList, .hotNewsList')
        ...
        .map((item) => {
            ...
            return {
                title: a.text(),
                link: link.startsWith('http') ? link : `${Object.prototype.hasOwnProperty.call(rootUrls, category) ? rootUrls[category] : defaultRootUrl}${link}`,
            };
        });
