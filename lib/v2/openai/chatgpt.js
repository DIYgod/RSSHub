...
module.exports = async (ctx) => {
    ...
    const items = await ctx.cache.tryGet(articleUrl, async () => {
        const returns = [];
        ...
        feedTitle = page.props.pageProps.articleContent.title;
        feedDesc = page.props.pageProps.articleContent.description;
        ...
        $blocks.forEach((block) => {
            ...
            if (block.type === 'subheading') {
                ...
                const matchesPubDate = heading.match(/\((.+\d{1,2})\)$/);
