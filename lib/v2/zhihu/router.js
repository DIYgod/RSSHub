module.exports = (router) => {
    ...
    router.get('/daily/section/:sectionId', require('./daily-section'));
    ...
    router.get('/topic/:topicId/:isTop?', require('./topic'));
    ...
    router.get('/xhu/people/posts/:hexId', require('./xhu/posts'));
