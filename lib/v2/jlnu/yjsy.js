...
const host = 'https://www.jlnu.edu.cn';
module.exports = async (ctx) => {
    ...
    const typeName = $('.sub_tt .tit').text() || '研究生院';
    const list = $('.sub_cont .sub_list ul li');
    ...
    ctx.state.data = {
        title: `吉林师范大学研究生院 - ${typeName}`,
        link: pageUrl,
        description: `吉林师范大学研究生院 - ${typeName}`,
        item: items,
    };
};
