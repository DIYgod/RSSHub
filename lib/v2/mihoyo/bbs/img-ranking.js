...
const getRankingTypeInfo = (list_type) => RANKING_TYPE_MAP[list_type];

module.exports = async (ctx) => {
    const { game, forum_type = 'tongren', cate_type, ranking_type = 'daily', page_size = '20', last_id = '' } = ctx.params;
    ...
    const { id: type, title: type_title } = getRankingTypeInfo(ranking_type);
