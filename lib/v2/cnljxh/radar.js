module.exports = {
    'cnljxh.com': {
        ...
        '.': [
            {
                title: '汇总',
                docs: 'https://docs.rsshub.app/routes/other#zhong-guo-lian-jiao-hang-ye-xie-hui',
                source: ['/collect'],
                target: (_, url) => {
                    url = new URL(url);
            ...
            {
                title: '价格汇总',
                docs: 'https://docs.rsshub.app/routes/other#zhong-guo-lian-jiao-xing-ye-xie-hui-hui-zong',
                source: ['/collect'],
                target: '/cnljxh/collect/10039',
            },
            {
                title: '焦炭指数',
                docs: 'https://docs.rsshub.app/routes/other#zhong-guo-lian-jiao-xing-ye-xie-hui-jia-ge-zhi-shu',
                source: ['/date'],
            ...
            {
                title: '市场分析',
                docs: 'https://docs.rsshub.app/routes/other#zhong-guo-lian-jiao-xing-ye-xie-hui-fen-xi-shu-ju',
                source: ['/info'],
            ...
            {
                title: '协会专区 - 协会简介',
                docs: 'https://docs.rsshub.app/routes/other#zhong-guo-lian-jiao-xing-ye-xie-hui-xin-wen',
                source: ['/news'],
            ...
            {
                title: '价格行情',
                docs: 'https://docs.rsshub.app/routes/other#zhong-guo-lian-jiao-xing-ye-xie-hui-jia-ge',
                source: ['/price'],
