...
const host = 'https://www.scuec.edu.cn';
module.exports = async (ctx) => {
    ...
    const typeName = $('#list .title .posSplit').last().next().text() || '研究生院';
    const list = $('.news-list .postTime');
    ...
    ctx.state.data = {
        title: `中南民族大学研究生院 - ${typeName}`,
        link: pageUrl,
        description: `中南民族大学研究生院 - ${typeName}`,
        item: items,
    };
};
