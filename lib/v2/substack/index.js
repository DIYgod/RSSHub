...
module.exports = async (ctx) => {
    ...
    let posts = data.posts.map((post) => ({
        ...
        description: _renderDescription({
            ...
            truncatedBodyText: post.truncated_body_text,
...
const _renderDescription = ({ link, subtitle, coverImage, truncatedBodyText, wordcount, tags, reactions }) =>
    art(path.join(__dirname, 'templates/description.art'), {
        ...
        wordcount,
        tags,
        reactions: reactions ? reactions[Object.keys(reactions)[0]] : null,
    });
