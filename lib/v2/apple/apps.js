...
module.exports = async (ctx) => {
    ...
    if (platform) {
        ...
        platformId = Object.prototype.hasOwnProperty.call(platforms, platform) ? platforms[platform] : platform;
    }
    platform = undefined;
    ...
    if (platformId && Object.prototype.hasOwnProperty.call(platformAttributes, platformId)) {
        platform = Object.prototype.hasOwnProperty.call(platformIds, platformId) ? platformIds[platformId] : platformId;
    ...
    items = items.slice(0, limit).map((item) => {
        ...
        const p = platform ? platform : Object.prototype.hasOwnProperty.call(platformIds, pid) ? platformIds[pid] : pid;
