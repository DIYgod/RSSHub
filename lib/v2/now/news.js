...
module.exports = async (ctx) => {
    ...
    const currentUrl = categories.hasOwnProperty(category) ? `${rootUrl}/home/${category}/detail?catCode=${categories[category]}&topicId=${id}` : `${rootUrl}/home${category ? `/${category}` : ''}`;
