...
module.exports = async (ctx) => {
    ...
    const currentUrl = Object.prototype.hasOwnProperty.call(categories, category) ? `${rootUrl}/home/${category}/detail?catCode=${categories[category]}&topicId=${id}` : `${rootUrl}/home${category ? `/${category}` : ''}`;
    ...
    ctx.state.data = {
        title: String(Object.prototype.hasOwnProperty.call(categories, category) ? $('title').text() : ($('.smallSpace.active').text() || '首頁') + ' | Now 新聞'),
        link: currentUrl,
        item: items,
    };
};
