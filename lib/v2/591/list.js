...
const renderHouse = (house) => art(path.join(__dirname, 'templates/house.art'), { house, rawHouse: JSON.stringify(house) });
...
module.exports = async (ctx) => {
    ...
    if (!isValidHost(country) && country !== 'tw') {
        throw Error('Invalid country codes. Only "tw" is supported now.');
    }
