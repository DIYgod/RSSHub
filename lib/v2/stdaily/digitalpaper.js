...
const getArticleList = ($, paperUrl, page, pubDate) => {
...
const createGetPageArticleList = (paperUrl, page = 1, pubDate) => {
    const getPageArticleList = async () => {
        ...
        const $ = cheerio.load(response.data);
        return getArticleList($, paperUrl, page, pubDate);
    };
...
module.exports = async (ctx) => {
    ...
    allPageArticleLists.push(...getArticleList($, currentUrl, 1));
