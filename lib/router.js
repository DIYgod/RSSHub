...
// Vulture
router.get('/vulture/tv', require('./routes/vulture/tv'));
router.get('/vulture/movies', require('./routes/vulture/movies'));
router.get('/vulture/comedy', require('./routes/vulture/comedy'));
router.get('/vulture/music', require('./routes/vulture/music'));
router.get('/vulture/tvrecaps', require('./routes/vulture/tvrecaps'));
router.get('/vulture/books', require('./routes/vulture/books'));
router.get('/vulture/theater', require('./routes/vulture/theater'));
router.get('/vulture/art', require('./routes/vulture/art'));
router.get('/vulture/awards', require('./routes/vulture/awards'));
router.get('/vulture/video', require('./routes/vulture/video'));
