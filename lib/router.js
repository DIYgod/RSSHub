...
router.get('/disinformationindex/blog', require('./routes/disinformationindex/blog'));
router.get('/disinformationindex/research', require('./routes/disinformationindex/research'));
