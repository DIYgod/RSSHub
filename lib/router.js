...
// eLife [Sci Journal]
router.get('/elife/latest', require('./routes/journals/elife/latest'));
router.get('/elife/:tid', require('./routes/journals/elife/subject'));

// PNAS [Sci Journal]
router.get('/pnas/latest', require('./routes/journals/pnas/latest'));
router.get('/pnas/:tid', require('./routes/journals/pnas/topic'));
