...
// 中国石油大学(北京)
router.get('/cup', require('./routes/universities/cup/cup'));
// 中国石油大学(北京)研究生院
router.get('/cupyjs', require('./routes/universities/cup/cupyjs'));
// 中国石油大学(北京)人工智能学院
router.get('/cupai', require('./routes/universities/cup/cupai'));
// 中国石油大学(北京)学生工作部
router.get('/cupxgb', require('./routes/universities/cup/cupxgb'));
// 中国石油大学(北京)团委
router.get('/cuptw', require('./routes/universities/cup/cuptw'));
