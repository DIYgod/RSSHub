...
// 上海电力大学
router.get('/shiep/news', require('./routes/universities/shiep/news'));
router.get('/shiep/department/energy', require('./routes/universities/shiep/department/energy'));
router.get('/shiep/department/hhxy', require('./routes/universities/shiep/department/hhxy'));
router.get('/shiep/department/dqxy', require('./routes/universities/shiep/department/dqxy'));
router.get('/shiep/department/zdhxy', require('./routes/universities/shiep/department/zdhxy'));
router.get('/shiep/department/jsjxy', require('./routes/universities/shiep/department/jsjxy'));
router.get('/shiep/department/dxxy', require('./routes/universities/shiep/department/dxxy'));
router.get('/shiep/department/jgxy', require('./routes/universities/shiep/department/jgxy'));
router.get('/shiep/department/slxy', require('./routes/universities/shiep/department/slxy'));
router.get('/shiep/department/wgyxy', require('./routes/universities/shiep/department/wgyxy'));
router.get('/shiep/department/gjjlxy', require('./routes/universities/shiep/department/gjjlxy'));
router.get('/shiep/department/jjxy', require('./routes/universities/shiep/department/jjxy'));
router.get('/shiep/department/skb', require('./routes/universities/shiep/department/skb'));
router.get('/shiep/department/tyb', require('./routes/universities/shiep/department/tyb'));
router.get('/shiep/department/yjzx', require('./routes/universities/shiep/department/yjzx'));
