...
// 雷峰网
router.get('/leiphone/latest', lazyloadRouteHandler('./routes/leiphone/latest'));
router.get('/leiphone/newsflash', lazyloadRouteHandler('./routes/leiphone/newsflash'));
router.get('/leiphone/category/:catname', lazyloadRouteHandler('./routes/leiphone/category'));
