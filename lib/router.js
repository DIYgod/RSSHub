...
// BookBang
router.get('/bookbang/review', require('./routes/bookbang/review'));
router.get('/bookbang/serial/:id', require('./routes/bookbang/serial'));

// Aeon
router.get('/aeon/:id', require('./routes/aeon/index'));
