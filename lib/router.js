...
// JavDB
router.get('/javdb/home/:category?/:sort?/:filter?', require('./routes/javdb/index'));
router.get('/javdb/search/:keyword?/:filter?', require('./routes/javdb/search'));
router.get('/javdb/tags/:query?/:category?', require('./routes/javdb/tags'));
...
router.get('/javdb/rankings/:category?/:time?', require('./routes/javdb/rankings'));
router.get('/javdb/:category?/:sort?/:filter?', require('./routes/javdb/index'));
