...
// JavBus
router.get('/javbus/home/:mode?', require('./routes/javbus/home'));
router.get('/javbus/genre/:gid/:mode?', require('./routes/javbus/genre'));
router.get('/javbus/star/:sid/:mode?', require('./routes/javbus/star'));
router.get('/javbus/uncensored/home/:mode?', require('./routes/javbus/uncensored/home'));
router.get('/javbus/uncensored/genre/:gid/:mode?', require('./routes/javbus/uncensored/genre'));
router.get('/javbus/uncensored/star/:sid/:mode?', require('./routes/javbus/uncensored/star'));
router.get('/javbus/western/home/:mode?', require('./routes/javbus/western/home'));
router.get('/javbus/western/genre/:gid/:mode?', require('./routes/javbus/western/genre'));
router.get('/javbus/western/star/:sid/:mode?', require('./routes/javbus/western/star'));
