...
if (config.pixiv && config.pixiv.client_id && config.pixiv.client_secret && config.pixiv.username && config.pixiv.password) {
    ...
    router.get('/pixiv/user/bookmarks/:id', require('./routes/lostToken'));
    router.get('/pixiv/user/:id/', require('./routes/lostToken'));
    router.get('/pixiv/ranking/:mode/:date?', require('./routes/lostToken'));
    router.get('/pixiv/search/:keyword/:order?', require('./routes/lostToken'));
...
if (config.disqus && config.disqus.api_key) {
    ...
    router.get('/disqus/posts/:forum', require('./routes/lostToken'));
...
if (config.twitter && config.twitter.consumer_key && config.twitter.consumer_secret) {
    ...
    router.get('/twitter/user/:id', require('./routes/lostToken'));
    router.get('/twitter/list/:id/:name', require('./routes/lostToken'));
    router.get('/twitter/likes/:id', require('./routes/lostToken'));
...
if (config.youtube && config.youtube.key) {
    ...
    router.get('/youtube/user/:username/:embed?', require('./routes/lostToken'));
    router.get('/youtube/channel/:id/:embed?', require('./routes/lostToken'));
    router.get('/youtube/playlist/:id/:embed?', require('./routes/lostToken'));
...
if (config.telegram && config.telegram.token) {
    ...
    if (config.imgur && config.imgur.clientId) {
        ...
        router.get('/telegram/stickerpack/:name', require('./routes/lostToken'));
        logger.warn('Telegram Sticker Pack RSS is disabled due to the lack of token, api key or relevant config in config.js.');
    }
} else {
    router.get('/telegram/channel/:username', require('./routes/lostToken'));
...
if (config.github && config.github.access_token) {
    ...
    router.get('/github/repos/:user', require('./routes/lostToken'));
