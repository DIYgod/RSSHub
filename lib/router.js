...
router.get('/njust/dgxg/:type?', lazyloadRouteHandler('./routes/universities/njust/dgxg'));
router.get('/njust/eoe/:type?', lazyloadRouteHandler('./routes/universities/njust/eoe'));
