...
// Rádio Macau
router.get('/radiomacau/cn/:category?', require('./routes/radiomacau/cn'));
// router.get('/radiomacau/pt', require('./routes/radiomacau/pt'));
// router.get('/radiomacau/en', require('./routes/radiomacau/en'));
