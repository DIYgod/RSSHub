...
// 巴哈姆特電玩資訊站
router.get('/gamer/forum/hot/:bsn?', require('./routes/gamer/hot'));
router.get('/gamer/gnn/:category?', require('./routes/gamer/index'));
router.get('/gamer/:category?', require('./routes/gamer/index'));
router.get('/gnn/gnn', require('./routes/gamer/index'));
