...
// 中国人工智能学会
router.get('/gov/beijing/caai/:caty', lazyloadRouteHandler('./routes/gov/beijing/caai'));

// CCF大数据专家委员会
router.get('/gov/beijing/tfbd/:caty/:id', lazyloadRouteHandler('./routes/gov/beijing/tfbd'));
