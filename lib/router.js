...
router.get('/youtube/user/:username/:embed/:maxResults', require('./routes/youtube/user'));
router.get('/youtube/channel/:id/:embed?', require('./routes/youtube/channel'));
router.get('/youtube/channel/:id/:embed/:maxResults', require('./routes/youtube/channel'));
router.get('/youtube/playlist/:id/:embed?', require('./routes/youtube/playlist'));
router.get('/youtube/playlist/:id/:embed/:maxResults', require('./routes/youtube/playlist'));
