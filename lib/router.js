...
// TokenInsight
router.get('/tokeninsight/bulletin', lazyloadRouteHandler('./routes/tokeninsight/bulletin.js'));
router.get('/tokeninsight/blog', lazyloadRouteHandler('./routes/tokeninsight/blog.js'));
router.get('/tokeninsight/report', lazyloadRouteHandler('./routes/tokeninsight/report.js'));
