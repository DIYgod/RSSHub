...
router.get('/xueqiu/livenews', lazyloadRouteHandler('./routes/xueqiu/livenews'));
...
// 淘股吧论坛
router.get('/taoguba/bbs', lazyloadRouteHandler('./routes/taoguba/bbs'));
router.get('/taoguba/jinghua', lazyloadRouteHandler('./routes/taoguba/jinghua'));
router.get('/taoguba/zongban', lazyloadRouteHandler('./routes/taoguba/zongban'));
router.get('/taoguba/dianzan', lazyloadRouteHandler('./routes/taoguba/dianzan'));
...
// 91porny
router.get('/91porny/recent-favorite', lazyloadRouteHandler('./routes/91porny/recent-favorite'));
router.get('/91porny/hot-list', lazyloadRouteHandler('./routes/91porny/hot-list'));
router.get('/91porny/recent-rating', lazyloadRouteHandler('./routes/91porny/recent-rating'));

// caoliu1024
router.get('/caoliu1024/asmr', lazyloadRouteHandler('./routes/caoliu1024/asmr'));
router.get('/caoliu1024/dagaier', lazyloadRouteHandler('./routes/caoliu1024/dagaier'));
router.get('/caoliu1024/jishutaolun', lazyloadRouteHandler('./routes/caoliu1024/jishutaolun'));
router.get('/caoliu1024/zhongziyuanchuang', lazyloadRouteHandler('./routes/caoliu1024/zhongziyuanchuang'));
router.get('/caoliu1024/xinshidaidewomen', lazyloadRouteHandler('./routes/caoliu1024/xinshidaidewomen'));
router.get('/caoliu1024/guochanyuanchuang', lazyloadRouteHandler('./routes/caoliu1024/guochanyuanchuang'));
// 剑网3
