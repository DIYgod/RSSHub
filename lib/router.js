...
// 限免
router.get('/giveaway/appfan', require('./routes/giveaway/appfan'));
router.get('/giveaway/alienwarearena', require('./routes/giveaway/alienwarearena'));

// 漫画
router.get('/comic/177mh/:id', require('./routes/comic/177mh'));
router.get('/comic/90mh/:id', require('./routes/comic/90mh'));
router.get('/comic/gufengmh8/:id', require('./routes/comic/gufengmh8'));
router.get('/comic/kukudm/:id', require('./routes/comic/kukudm'));
router.get('/comic/laimanhua/:id', require('./routes/comic/laimanhua'));
router.get('/comic/manhuadb/:id', require('./routes/comic/manhuadb'));
router.get('/comic/manhuadui/:id', require('./routes/comic/manhuadui'));
router.get('/comic/twocomic/:id', require('./routes/comic/twocomic'));

router.get('/comic/bilibili/:id', require('./routes/comic/bilibili'));
router.get('/comic/dmzj/:id/:name', require('./routes/comic/dmzj'));

// 温州医科大学
router.get('/wzyk/jwc/:a/:b?', require('./routes/universities/wzyk/jwc'));

// 抓取
router.get('/grab/:url/:title', require('./routes/grab/index'));

// JavBus
router.get('/javbus/:a?/:b?/:c?', require('./routes/javbus/common'));
router.get('/javbus-western/:a?/:b?/:c?', require('./routes/javbus/common-western'));
router.get('/javbus-mini/:a?/:b?/:c?', require('./routes/javbus/mini'));
