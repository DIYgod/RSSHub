...
// 性感美女屋
router.get('/xgyw/new/:count?', require('./routes/xgyw/new'));
router.get('/xgyw/hot/:count?', require('./routes/xgyw/hot'));
router.get('/xgyw/search/:key/:count/:speed?', require('./routes/xgyw/search'));
