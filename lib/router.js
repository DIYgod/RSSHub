...
// javlibrary
router.get('/javlibrary/bestrated', require('./routes/javlibrary/bestrated'));
router.get('/javlibrary/userposts/:uid', require('./routes/javlibrary/userposts'));
router.get('/javlibrary/userowned/:uid', require('./routes/javlibrary/userowned'));
router.get('/javlibrary/userwanted/:uid', require('./routes/javlibrary/userwanted'));
router.get('/javlibrary/userwatched/:uid', require('./routes/javlibrary/userwatched'));
