...
// 重庆大学
router.get('/cqu/jwc/', lazyloadRouteHandler('./routes/universities/cqu/jwc/announcement'));
...
router.get('/soul/posts/hot/', lazyloadRouteHandler('./routes/soul/hot'));
...
// discuz
// router.get('/discuz/:ver{[7x]}/:cid{[0-9]{2}}/:link{.+}', lazyloadRouteHandler('./routes/discuz/discuz'));
// router.get('/discuz/:ver{[7x]}/:link{.+}', lazyloadRouteHandler('./routes/discuz/discuz'));
