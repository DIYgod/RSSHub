...
// HelloGithub
router.get('/hellogithub/article', require('./routes/hellogithub/article'));
router.get('/hellogithub/ranking/:type', require('./routes/hellogithub/ranking'));
router.get('/hellogithub/month', require('./routes/hellogithub/month'));
