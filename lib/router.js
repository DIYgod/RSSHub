...
// Vimeo
router.get('/vimeo/user/:username/:cat?', require('./routes/vimeo/usr-videos'));
router.get('/vimeo/channel/:channel', require('./routes/vimeo/channel'));
router.get('/vimeo/category/:category/:subcategory?/:staffpicks?', require('./routes/vimeo/category'));
