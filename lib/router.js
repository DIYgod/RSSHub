...
// 大连理工大学
router.get('/dut/teach/:type', require('./routes/universities/dut/teach/index'));
router.get('/dut/tycgzx/:type', require('./routes/universities/dut/tycgzx/index'));
router.get('/dut/dutdice/:type', require('./routes/universities/dut/dutdice/index'));
