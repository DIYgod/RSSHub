...
// 最新作品
router.get('/matataki/posts/timeranking', require('./routes/matataki/posts/timeranking'));
// 最新作品 - IPFS
router.get('/matataki/ipfs/posts/timeranking', require('./routes/matataki/ipfs/posts/timeranking'));
// 作者作品
router.get('/matataki/user/:authorId/posts', require('./routes/matataki/posts/author'));
// 作者作品 - IPFS
router.get('/matataki/ipfs/user/:authorId/posts', require('./routes/matataki/ipfs/posts/author'));
// Fan票关联作品
router.get('/matataki/minetoken/:id/related/:filterCode', require('./routes/matataki/minetoken/related'));
// Fan票关联作品 - IPFS
router.get('/matataki/ipfs/minetoken/:id/related/:filterCode', require('./routes/matataki/ipfs/minetoken/related'));
// 主题作品
router.get('/matataki/tags/:tagId/posts', require('./routes/matataki/posts/tag'));
// 主题作品 - IPFS
router.get('/matataki/ipfs/tags/:tagId/posts', require('./routes/matataki/ipfs/posts/tag'));
