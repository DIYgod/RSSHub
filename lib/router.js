...
// 国家新闻出版广电总局
router.get('/gov/sapprft/approval/:channel', require('./routes/gov/sapprft/7026'));
router.get('/gov/sapprft/approval/:channel/:detail', require('./routes/gov/sapprft/detail'));
