...
// 南京大学
router.get('/nju/jw/:type', lazyloadRouteHandler('./routes/universities/nju/jw'));
router.get('/nju/gra', lazyloadRouteHandler('./routes/universities/nju/gra'));
router.get('/nju/rczp/:type', lazyloadRouteHandler('./routes/universities/nju/rczp'));
router.get('/nju/scit/:type', lazyloadRouteHandler('./routes/universities/nju/scit'));
router.get('/nju/zcc', lazyloadRouteHandler('./routes/universities/nju/zcc'));
router.get('/nju/zbb/:type', lazyloadRouteHandler('./routes/universities/nju/zbb'));
