...
// e-hentai
router.get('/ehentai/favorites/:favcat?/:order?/:page?/:bittorrent?', require('./routes/ehentai/favorites'));
router.get('/ehentai/search/:params?/:page?/:bittorrent?', require('./routes/ehentai/search'));
router.get('/ehentai/tag/:tag/:page?/:bittorrent?', require('./routes/ehentai/tag'));
