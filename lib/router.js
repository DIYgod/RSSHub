...
router.get('/chinadialogue/article', require('./routes/chinadialogue/article'));
router.get('/chinadialogue/blog', require('./routes/chinadialogue/blog'));
router.get('/chinadialogue/culture', require('./routes/chinadialogue/culture'));
router.get('/chinadialogue/reports', require('./routes/chinadialogue/reports'));
