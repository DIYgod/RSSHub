...
router.get('/scvtc/xyxw', require('./routes/universities/scvtc/xyxw/xyxw'));
router.get('/scvtc/jwcgg', require('./routes/universities/scvtc/jwcgg/jwcgg'));
router.get('/scvtc/jwctz', require('./routes/universities/scvtc/jwctz/jwctz'));
