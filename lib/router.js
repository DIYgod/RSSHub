...
// 界面新闻-首页
router.get('/jiemian/index', require('./routes/jiemian/index'));
...
router.get('/smzdm/sns/:id?', require('./routes/smzdm/sns'));
...
// 万家热线-咨询
router.get('/wanjia/index', require('./routes/365jia/news'));
