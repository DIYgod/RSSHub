...
// 上海立信会计金融学院
router.get('/slu/tzgg/:type?', require('./routes/universities/slu/tzgg'));
router.get('/slu/jwc/:type?', require('./routes/universities/slu/jwc'));
router.get('/slu/tyyjkxy/:type?', require('./routes/universities/slu/tyyjkxy'));
router.get('/slu/kjxy/:type?', require('./routes/universities/slu/kjxy'));
router.get('/slu/xsc/:type?', require('./routes/universities/slu/xsc'));
router.get('/slu/csggxy/:type?', require('./routes/universities/slu/csggxy'));
