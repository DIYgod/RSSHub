...
const calculateValue = () => {
    ...
    value = {
        ...
        requestRetry: parseInt(envs.REQUEST_RETRY) || 1, // 请求失败重试次数
        ...
        cache: {
            ...
            routeExpire: parseInt(envs.CACHE_EXPIRE) || 10 * 60, // 路由缓存时间，单位为秒
            contentExpire: parseInt(envs.CACHE_CONTENT_EXPIRE) || 8 * 60 * 60, // 不变内容缓存时间，单位为秒
        },
        memory: {
