...
const calculateValue = () => {
    ...
    value = {
        ...
        hotlink: {
            // @params https://developer.mozilla.org/en-US/docs/Web/API/URL#Properties
            // @params ${noProtocal} a custom attribute targeted at the issue
            // @required JS template literal format
            // https://github.com/DIYgod/RSSHub/issues/2769
            // e.g. '${url.protocol}//${url.host}${url.pathname}', 'https://i3.wp.com/${noProtocol}'
            // Or you may use relative if you have special usage. E.g Proxy path, etc.
