...
<route name="问题" author="xyqfer" example="/zhihu/question/59895982" path="/zhihu/question/:questionId/:sort?" :paramsDesc="['问题 id', '回答排序方式，默认为`default`默认排序，可选`created`按时间排序']"/>
