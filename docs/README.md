...
<route name="国家电网" author="xyqfer" example="/tingdiantz/95598/36401/36101/2018-12-11/2018-12-18" path="/tingdiantz/95598/:orgNo/:provinceNo/:outageStartTime(Deprecated, invalid)/:outageEndTime(Deprecated, invalid)/:scope?" :paramsDesc="['所属省供电公司编码', '所属地市供电公司编码', '开始时间（已弃用，固定为当前日期-1天）', '结束时间（已弃用，固定为当前日期+1天）', '停电范围关键字']"/>
