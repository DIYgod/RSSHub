...
<route name="视频弹幕" author="Qixingchen" example="/bilibili/video/danmuku/21669336/1" path="/bilibili/video/reply/:aid/:pid?" :paramsDesc="['视频AV号,可在视频页 URL 中找到','分P号,不填默认为1']"/>
