...
<Route author="zytomorrow" example="/weibo/home_timeline/12345678" path="/weibo/home_timeline/:uid/:feature?" :paramsDesc="['用户的uid', '	过滤类型ID，0：全部、1：原创、2：图片、3：视频、4：音乐，默认为0。']" anticra>
::: warning 注意
