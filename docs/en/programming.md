...
<RouteEn author="hashman TonyRL" example="/github/pull/DIYgod/RSSHub" path="/github/pull/:user/:repo/:state?" :paramsDesc="['User name', 'Repo name', 'the state of the issues. Can be either `open`, `closed`, or `all`. Default: `open`.']" radar="1" rssbud="1"/>
