...
::: tip
You can find the `category` by using the table above, or via the URL on the Substack website: `https://substack.com/browse/<category name you need>`.
:::
...
Every request has the `User-Agent` header of Mozilla Firefox in order to not be too suspicious.
:::
