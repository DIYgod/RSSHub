...
<RouteEn author="nczitzk" example="/hbr/topic/leadership" path="/hbr/topic/:topic?" :paramsDesc="['Topic, can be found in URL, Leadership by default', 'Type, see below, Latest by default']">
