...
<RouteEn author="nczitzk" example="/wallhaven/latest" path="/wallhaven/:category?/:needDetails?" :paramsDesc="['Category, see below, Latest by default', 'Need Details, `true/yes` as yes, no by default']">
...
<RouteEn author="nczitzk" example="/wallhaven" path="/wallhaven/:filter?/:needDetails?" :paramsDesc="['Filter, empty by default', 'Need Details, `true/yes` as yes, no by default']">
