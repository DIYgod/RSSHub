...
<Route author="yanbot-team" example="/sassorgcn/gs/1793" path="/sassorgcn/gs/:type" :paramsDesc="['类别ID，其他未列出的栏目参数可以从页面的 URL Path 中找到，例如：硕士统考招生的网址为https://gs.sass.org.cn/1793/list.htm，则类别ID为1793']" radar="1" >
