...
若没有设置 `DISABLE_USER_HOTLINK_TEMPLATE`，请转到 [通用参数 -> 多媒体处理](/parameter.html#duo-mei-ti-chu-li) 中进行相关配置。

:::

`DISABLE_USER_HOTLINK_TEMPLATE`: 禁止用户通过 [通用参数 -> 多媒体处理](/parameter.html#duo-mei-ti-chu-li) 提供自定义模板，默认 `false`
