# Naver Webtoon docs — redirect

Connector documentation consolidated under **`docs/impl/`** (dragnet 2026-06).

| Need                    | Read                                                                   |
| ----------------------- | ---------------------------------------------------------------------- |
| RSSHub route (current)  | [`../impl/IMPL-08-naver-webtoon.md`](../impl/IMPL-08-naver-webtoon.md) |
