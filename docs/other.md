...
<Route author="Jkker" example="/oceanengine/教材" path="oceanengine/:keyword" :paramsDesc="['热点关键词']" anticrawler="1"/>

爬取巨量算数近 6 个月的抖音指数，解密后提取指数波峰当日的热门搜索关键词，生成为 RSS。可用于追踪新闻热点事件。

### 头条指数波峰

<Route author="Jkker" example="/oceanengine/教材/toutiao" path="oceanengine/:keyword/toutiao" :paramsDesc="['热点关键词']" anticrawler="1"/>
