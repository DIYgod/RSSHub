        ...
        asa: [
            {
                ...
                source: '/*',
                target: '/jasa/section/reflections',
            },
            {
                title: 'ANIMAL BIOACOUSTICS',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/animal',
            },
            {
                title: 'COMPUTATIONAL ACOUSTICS',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/computational',
            },
            {
                title: 'ENGINEERING ACOUSTICS',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/engineering',
            },
            {
                title: 'MUSICAL ACOUSTICS',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/musical',
            },
            {
                title: 'NOISE',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/noise',
            },
            {
                title: 'PHYSICAL ACOUSTICS',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/physical',
            },
            {
                title: 'PSYCHOLOGICAL AND PHYSIOLOGICAL ACOUSTICS',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/psychological',
            },
            {
                title: 'SIGNAL PROCESSING IN ACOUSTICS',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/signalprocessing',
            },
            {
                title: 'SPEECH COMMUNICATION',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/speech',
            },
            {
                title: 'UNDERWATER ACOUSTICS',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/underwater',
            },
            {
                title: 'LETTERS TO THE EDITOR',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/letters',
            },
            {
                title: 'ERRATA',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/errata',
            },
            {
                title: 'ACOUSTICAL STANDARDS NEWS',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/standardsnews',
            },
            {
                title: 'REVIEWS OF ACOUSTICAL PATENTS',
                docs: 'https://docs.rsshub.app/journal.html#jasa',
                source: '/*',
                target: '/jasa/section/reviewspatents',
            },
        ],
    },
});
