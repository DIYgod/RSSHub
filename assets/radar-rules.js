({
    ...
    'vimeo.com': {
        ...
        '.': [
            {
                title: 'User videos',
                docs: 'https://docs.rsshub.app/design.html#vimeo-yong-hu-ye-mian',
                source: '/:username/',
                target: (params, url, document) => {
