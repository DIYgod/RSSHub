...
<Route author="CookiePieWw" example="/liquipedia/counterstrike/matches/G2_Esports" path="liquipedia/dota2/matches/:id" path="liquipedia/dota2/matches/:id" paramsDesc={['战队名称，可在url中找到。例如:https://liquipedia.net/counterstrike/G2_Esports']}/>
