...
<Route author="CookiePieWw" example="/liquipedia/counterstrike/matches/G2_Esports" path="liquipedia/counterstrike/matches/:id" path="liquipedia/counterstrike/matches/:id" paramsDesc={['战队名称，可在url中找到。例如:https://liquipedia.net/counterstrike/G2_Esports']}/>
