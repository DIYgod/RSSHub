...
- 演出城市 `cityCode` 可通过关键词搜索获得, 如: https://rsshub.app/showstart/search/city/杭州

- 演出风格 `showStyle` 可通过关键词搜索获得，如: https://rsshub.app/showstart/search/style/摇滚
...
音乐人 ID 可通过搜索艺人获得，如: https://rsshub.app/showstart/search/artist/周杰伦
...
厂牌 ID 可通过搜索关键词获得，如: https://rsshub.app/showstart/search/brand/声场
