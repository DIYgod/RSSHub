...
<Route author="lchtao26" example="/showstart/event/571/0/livehouse" path="/showstart/event/:cityCode/:showStyle/:keyword?/" paramsDesc={['演出城市 (编号)', '演出风格 (编号)，如无限制，填 0', '搜索关键词']}/>
