...
<Route author="nightmare-mio" example="http://127.0.0.1:1200/bilibili/platform/" path="/platform/:area?/:p_type?/:uid?" paramsDesc={['省市-国标码','类型：见下表','用户id，可以在url中找到，需要配置cookie值，只需要SESSDATA的值即可']}/>
