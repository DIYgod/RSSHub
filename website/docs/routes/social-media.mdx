...
<Route namespace="newrank" data={{"path":"/wechat/:wxid","categories":["social-media"],"example":"/newrank/wechat/chijiread","parameters":{"wxid":"微信号，若微信号与新榜信息不一致，以新榜为准"},"features":{"requireConfig":true,"requirePuppeteer":false,"antiCrawler":true,"supportBT":false,"supportPodcast":false,"supportScihub":false},"name":"微信公众号","maintainers":["lessmoe"],"location":"wechat.ts"}} />
...
<Route namespace="zhihu" data={{"path":"/timeline","categories":["social-media"],"example":"/zhihu/timeline","parameters":{},"features":{"requireConfig":true,"requirePuppeteer":false,"antiCrawler":true,"supportBT":false,"supportPodcast":false,"supportScihub":false},"name":"用户关注时间线","maintainers":["SeanChao"],"description":":::warning\n  用户关注动态需要登录后的 Cookie 值，所以只能自建，详情见部署页面的配置模块。\n  :::","location":"timeline.ts"}} />
