...
<Route author="ImSingee" example="/soul/Y2w2aTNWQVBLOU09" path="/soul/:id" paramsDesc={['用户 id, 分享用户主页时的 URL 的 userIdEcpt 参数']} radar="1" notOperational="1"></Route>
...
<Route author="synchrone" example="/telegram/channel/telegram" path="/telegram/channel/:name" paramsDesc={['Channel name, without @']} configRequired="1"/>

:::warning
This route requires user-based `TELEGRAM_SESSION` which can be acquired
:::
