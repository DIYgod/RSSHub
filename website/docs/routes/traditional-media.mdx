...
## Klotener Anzeiger {#klotener-anzeiger}

### News {#klotener-anzeiger-news}

<Route author="YourGitHubUsername" example="/v2/kloteneranzeiger/news" path="/v2/kloteneranzeiger/news" radar="1" rssbud="1" paramsDesc="No parameters required. This route fetches the latest news articles from Klotener Anzeiger." />
