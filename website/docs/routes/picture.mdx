...
<Route namespace="jpxgmn" data={{"path":"/weekly","categories":["picture"],"example":"/jpxgmn/weekly","features":{"requireConfig":false,"requirePuppeteer":false,"antiCrawler":false,"supportBT":false,"supportPodcast":false,"supportScihub":false},"name":"本周热门","maintainers":["Urabartin"],"location":"weekly.ts"}} />

### 分类

<Route namespace="jpxgmn" data={{"path":"/tab/:tab?","categories":["picture"],"example":"/jpxgmn/tab","parameters":{"tab":"分类，默认为`top`，包括`top`、`new`、`hot`，以及[源网站](http://www.jpxgmn.com/)所包含的其他相对路径，比如`Xiuren`、`XiaoYu`等"},"features":{"requireConfig":false,"requirePuppeteer":false,"antiCrawler":false,"supportBT":false,"supportPodcast":false,"supportScihub":false},"name":"分类","maintainers":["Urabartin"],"location":"tab.ts"}} />

### 搜索

<Route namespace="jpxgmn" data={{"path":"/search/:kw","categories":["picture"],"example":"/jpxgmn/search/candy","parameters":{"kw":"搜索关键词"},"features":{"requireConfig":false,"requirePuppeteer":false,"antiCrawler":false,"supportBT":false,"supportPodcast":false,"supportScihub":false},"name":"搜索","maintainers":["Urabartin"],"location":"search.ts"}} />
