...
<Route author="nczitzk" example="/transcriptforest/all-the-hacks" path="/transcriptforest" paramsDesc={['Channel, see below, all by default']} radar="1" supportBT="1" supportPodcast="1">
  | Channel                                                                                                                                        | ID                                                                                                                                     |
  | ---------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
