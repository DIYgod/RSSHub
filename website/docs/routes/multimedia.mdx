...
### 最近更新 {#ke-la-man-bo-zui-jin-geng-xin}

<Route author="wenmoux" example="/latest/drama" path="/latest/:category?" paramsDesc={['分类，见下表，默认为drama，即广播剧']} radar="1">
  地区

  | 广播剧 | 音乐  | 有声书 | 有声漫画 | 播客    |
  | ------ | ----- | ------ | -------- | ------- |
  | drama  | music | book   | manhua   | podcast |
</Route>
