...
### SF 轻小说 / 菠萝包轻小说 章节 {#sfacg-sf-qing-xiao-shuo-bo-luo-bao-qing-xiao-shuo-zhang-jie}

<Route author="keocheung" example="/sfacg/novel/chapter/672431" path="/sfacg/novel/chapter/:id" paramsDesc={['小说 id, 可在对应小说页 URL 中找到']} />
