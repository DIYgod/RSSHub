...
<Route author="ShiFangJuMie" example="/macbl/latest" path="/macbl/latest" />

## MacFK {#MacFK}

### 最近更新macOS软件 {#MacFK-mac}

<Route author="ShiFangJuMie" example="/MacFK/app" path="/MacFK/:category" paramsDesc={['分类名, app是macOS软件，windows顾名思义']} />

### 最近更新Windows软件 {#MacFK-win}

<Route author="ShiFangJuMie" example="/MacFK/windows" path="/MacFK/:category" paramsDesc={['分类名, app是macOS软件，windows顾名思义']} />
...
### 最近更新 {#tenlonstudio-new}

<Route author="ShiFangJuMie" example="/tenlonstudio/software" path="/tenlonstudio/:category" paramsDesc={['分类名, software全部、windows、macos、android、genuine正版限免']} />
