...
### Zero Day {#hitcon-zero-day}

<Route author="KarasuShin" example="/hitcon/zeroday/vulnerability/disclosed" paramsDesc={['分类，默认为活動中']} path="/hitcon/zeroday/vulnerability/:type?" radar="1">
  | 活動中 | 修補中   | 公開      | 全部 |
  | ------ | -------- | --------- | ---- |
  |        | patching | disclosed | all  |
</Route>
