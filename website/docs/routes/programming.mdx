...
### 新闻/聚合 {#rust-yu-yan-zhong-wen-she-qu-xin-wen}

<Route namespace="rustcc" data={{"path":"/news","categories":["programming"],"example":"/rustcc/news","parameters":{},"features":{"requireConfig":false,"requirePuppeteer":false,"antiCrawler":false,"supportBT":false,"supportPodcast":false,"supportScihub":false},"radar":{"source":["rustcc.cn/"]},"name":"新闻/聚合","maintainers":["zhenlohuang"],"url":"rustcc.cn/","location":"news.ts"}} />
