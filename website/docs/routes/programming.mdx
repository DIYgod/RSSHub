...
<Route author="fengkx" example="/cve/search/PostgreSQL" path="/cve/search/:keyword" paramsDesc={['keyword']} notOperational="1" />
...
<Route author="nczitzk" example="/deeplearningai/thebatch" path="/deeplearningai/thebatch" notOperational="1" />
...
<Route author="csi0n" example="/dockone/weekly" path="/dockone/weekly" notOperational="1" />
...
<Route author="hoilc" example="/gitchat/newest" path="/gitchat/newest/:category?/:selected?" paramsDesc={['分类 ID, 置空或`all`代表全部, 具体值需要抓取前端请求, 以下列出可能有变动, 仅供参考', '是否只显示严选文章, 任意值为是, 置空为否']} notOperational="1">
  | 分类名   | 分类 ID                  |
  | :------- | :----------------------- |
...
<Route author="cnzgray" example="/gitea/blog" path="/gitea/blog" notOperational="1">
...
<Route author="Yangshuqing" example="/itslide/new" path="/itslide/new" radar="1" notOperational="1" />

## Kaggle {#kaggle}

### Discussion {#kaggle-discussion}

<Route author="LogicJake" example="/kaggle/discussion/387811/active" path="/kaggle/discussion/:forumId/:sort?" paramsDesc={['Forum ID, open web request, search forumId; fill in all to subscribe to the whole site discussion forum', 'See the table below for sorting methods, default to hot']} notOperational="1">
...
<Route author="LogicJake" example="/kaggle/competitions" path="/kaggle/competitions/:category?" paramsDesc={['category, default to all']} notOperational="1">
...
<Route author="nczitzk" example="/kaggle/user/antgoldbloom" path="/kaggle/user/:user" paramsDesc={['用户名']} notOperational="1" />

## Layer3 {#layer3}

### Quest {#layer3-quest}

<Route author="nczitzk" example="/layer3/quests" path="/layer3/quests" radar="1" notOperational="1" />
...
<Route author="NathanDai" example="/leetcode/submission/us/nathandai" path="/leetcode/submission/:country/:user" paramsDesc={['country, Chines(cn) and US(us)', 'Username, available at the URL of the LeetCode user homepage']} notOperational="1" />
...
<Route author="imlonghao" example="/linkedkeeper/sub/1" path="/linkedkeeper/:type/:id?" paramsDesc={['博文分类, 为 URL 中 `.action` 的文件名', '分区或标签的 ID, 对应 URL 中的 `sid` 或 `tid`']} notOperational="1" />
...
<Route author="nczitzk" example="/nodejs/blog" path="/nodejs/blog/:language?" paramsDesc={['Language, see below, en by default']} notOperational="1">
...
<Route author="fengkx" example="/scala/blog/posts" path="/scala/blog/:part?" paramsDesc={['part parmater can be found in the url of blog']} notOperational="1" />
...
<Route author="umm233" example="/wolley" path="/wolley/index" notOperational="1" />

### user post {#wolley-user-post}

<Route author="umm233" example="/wolley/user/kyth" path="/wolley/user/:id" paramsDesc={['用户 id']} notOperational="1" />

### host {#wolley-host}

<Route author="umm233" example="/wolley/host/www.youtube.com" path="/wolley/host/:host" paramsDesc={['文章对应 host 分类']} notOperational="1" />
...
<Route author="Pulset" example="/zooTeam/blog" path="/zooTeam/blog" radar="1" notOperational="1" />

### weekly {#zooteam-zheng-cai-yun-qian-duan-ji-shu-tuan-dui-weekly}

<Route author="Pulset" example="/zooTeam/weekly" path="/zooTeam/weekly" radar="1" notOperational="1" />
...
<Route author="kaiili" example="/secnews" path="/secnews" notOperational="1" />
...
<Route author="phantomk" example="/eleme/open-be/announce" path="/eleme/open-be/announce" notOperational="1" />
...
<Route author="zhangzhxb520" example="/geektime/news" path="/geektime/news" notOperational="1" />
...
<Route author="qiwihui" example="/juejin/shares/56852b2460b2a099cdc1d133" path="/juejin/shares/:userId" paramsDesc={['用户 id, 可在用户页 URL 中找到']} radar="1" notOperational="1" />
...
<Route author="cancergary" example="/juejin/news/739332228916791" path="/juejin/news/:userId" paramsDesc={['用户 id, 可在用户页 URL 中找到']} radar="1" notOperational="1" />
...
<Route author="loveely7" example="/oschina/topic/weekly-news" path="/oschina/topic/:topic" paramsDesc={['主题名，可从 [全部主题](https://www.oschina.net/question/topics) 进入主题页，在 URL 中找到']} radar="1" notOperational="1" />
...
<Route author="nczitzk" example="/lianxh" path="/lianxh/:category?" paramsDesc={['分类 id，可在对应分类页 URL 中找到，默认为空，即全部']} notOperational="1">
  | 分类                 | id |
  | -------------------- | -- |
  | 全部                 |    |
  | Stata 入门           | 16 |
...
<Route author="mlogclub" example="/mlog-club/topics/newest" path="/mlog-club/topics/:node" paramsDesc={['node']} notOperational="1">
  | node      | 名称     |
  | --------- | -------- |
  | newest    | 最新话题 |
  | recommend | 热门话题 |
...
<Route author="mlogclub" example="/mlog-club/projects" path="/mlog-club/projects" notOperational="1" />

## 码农网 {#ma-nong-wang}

### 最新 {#ma-nong-wang-zui-xin}

<Route author="kt286" example="/codeceo/home" path="/codeceo/home" notOperational="1" />

### 分类 {#ma-nong-wang-fen-lei}

<Route author="kt286" example="/codeceo/category/java" path="/codeceo/category/:category?" paramsDesc={['category']} notOperational="1">
  | category        | 名称                |
  | --------------- | ------------------- |
  | news            | 资讯                |
  | java            | JAVA 开发           |
...
<Route author="kt286" example="/codeceo/tag/node.js" path="/codeceo/tag/:category?" paramsDesc={['tag']} notOperational="1">
  | tag        | 名称       |
  | ---------- | ---------- |
  | java       | java       |
  | javascript | javascript |
...
<Route author="kouchao" example="/jskou/0" path="/jskou/:type?" paramsDesc={['分类']} notOperational="1">
  | 前端艺术家 | 飞冰早报 |
  | ---------- | -------- |
  | 0          | 1        |
</Route>
...
<Route author="Andiedie" example="/d2/daily" path="/d2/daily" notOperational="1" />

## 顺丰 {#shun-feng}

### 顺丰丰桥开放平台公告 {#shun-feng-shun-feng-feng-qiao-kai-fang-ping-tai-gong-gao}

<Route author="phantomk" example="/sf/sffq-announce" path="/sf/sffq-announce" notOperational="1" />

## 腾讯大数据 {#teng-xun-da-shu-ju}

### 研报 {#teng-xun-da-shu-ju-yan-bao}

<Route author="nczitzk" example="/tencent/bigdata" path="/tencent/bigdata" notOperational="1" />
...
<Route author="xyqfer" example="/gameinstitute/community/hot" path="/gameinstitute/community/:tag?" paramsDesc={['标签名称，默认为热门']} notOperational="1">
...
<Route author="nczitzk" example="/tencent/cloud/column/86410" path="/tencent/cloud/column/:id?/:tag?" paramsDesc={['专栏 id，可在对应专栏页中找到，默认为 86410（腾讯云数据库专家服务）', '标签 id，可在对应专栏页中找到，默认为空']} notOperational="1" />
...
<Route author="HenryQW" example="/miniapp/article/cloud" path="/miniapp/article/:category" paramsDesc={['分类名称']} notOperational="1">
...
<Route author="xyqfer" example="/miniapp/store/newest" path="/miniapp/store/newest" notOperational="1" />

## 众成翻译 {#zhong-cheng-fan-yi}

### 首页 {#zhong-cheng-fan-yi-shou-ye}

<Route author="SirM2z" example="/zcfy" path="/zcfy/index" notOperational="1" />

### 热门 {#zhong-cheng-fan-yi-re-men}

<Route author="SirM2z" example="/zcfy/hot" path="/zcfy/hot" notOperational="1" />
