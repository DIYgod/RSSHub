...
### Biostars posts {#biostars-posts}

<Route author="william-swl" example="/biostars/posts" path="/biostars/posts"/>

Latest posts from [Biostars](https://www.biostars.org/)

### Biostars posts with tag {#biostars-tag}

<Route author="william-swl" example="/biostars/tag/rna-seq" path="/biostars/tag/:tag"/>

The tag list can be found at [here](https://www.biostars.org/t/).
