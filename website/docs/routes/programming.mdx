...
<Route author="FuryMartin" example="/qbitai/category/资讯" path="/category/:category" paramsDesc={['分类名，见下表']} />
...
<Route author="FuryMartin" example="/qbitai/tag/大语言模型" path="/tag/:tag" paramsDesc={['标签名']} />
