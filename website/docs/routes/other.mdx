...
### Internal Image Proxy {#rsshub-internal-image-proxy}

<Route author="TonyRL" example="/rsshub/i/key/https%3A%2F%2Fdocs.rsshub.app%2Fimg%2Flogo.png" path="/rsshub/i/:key/:url" paramsDesc={['Image Proxy Key', '`encodeURIComponent`ed URL address']} selfhost="1" />
