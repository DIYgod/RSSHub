...
<Route author="Duuckjing" example="/shisu/news/notice" path="/shisu/news/:category?" paramsDesc={['新闻的分类可根据自己的需要选择。若不填写分类`category`，默认为首页的全部新闻，此时`news`可不填']} radar="1">
| 首页 |   特稿   |   学术   |   教学   |      国际     |  校园  |  人物  |    视讯    |  公告  |
| ---- | -------- | -------- | -------- | ------------- | ------ | ------ | ---------- | ------ |
| news | feature  | research | academic | international | campus | people | multimedia | notice |
</Route>
