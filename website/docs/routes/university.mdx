...
## 北京师范大学-香港浸会大学联合国际学院 UIC {#bnu-hkbu-uic}

### UIC 新闻 {#bnu-hkbu-uic-news}

<Route author="heimoshuiyu" example="/uic/news/top_stories" path="/uic/news/:sub" paramsDesc={['新闻子类']}>
  |    头条     |    动态   |   深度   | 媒体聚焦 |
  | ----------- | -------- | -------  |  ---- |
  | top_stories | in_brief | features | media |
</Route>

### UIC 图书馆公告 {#bnu-hkbu-uic-lrc}

<Route author="heimoshuiyu" example="/uic/lrc" />

### UIC 理工科技学部 {#bnu-hkbu-uic-fst}

<Route author="heimoshuiyu" example="/uic/fst" />

### UIC 学生职业发展中心 {#bnu-hkbu-uic-career}

<Route author="heimoshuiyu" example="/uic/career/ygtz" path="/uic/career/:tag" paramsDesc={['新闻子类']}>
  |  ygtz  |  xsfx   |   gg    |    xngs    |   msjq  |  sjzxx |
  | -----  |  -----  |  ----   |  --------- | -----  |  ------ |
  | 中心新闻 | 学生风采 | 政府公告 | 就业质量报告 | 就业指南 | 升学讲座 |
</Route>
